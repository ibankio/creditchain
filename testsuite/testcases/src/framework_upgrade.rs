...
use creditchain_release_builder::ReleaseConfig;
...
const RELEASE_YAML_PATH: &str = "creditchain-move/creditchain-release-builder/data";
...
impl NetworkTest for FrameworkUpgrade {
    async fn run<'a>(&self, ctx: NetworkContextSynchronizer<'a>) -> Result<()> {
        ...
        let network_info = creditchain_release_builder::validate::NetworkConfig {
            endpoint: ctx
                .swarm
                .read()
                .await
        ...
        let release_config = creditchain_release_builder::current_release_config();

        creditchain_release_builder::validate::validate_config(

...
pub const CREDITCHAIN_NODE_HELM_RELEASE_NAME: &str = "creditchain-node";
pub const GENESIS_HELM_RELEASE_NAME: &str = "genesis";
pub const CREDITCHAIN_NODE_HELM_CHART_PATH: &str = "terraform/helm/creditchain-node";
...
pub const VALIDATOR_0_STATEFUL_SET_NAME: &str = "creditchain-node-0-validator";
pub const VALIDATOR_0_GENESIS_SECRET_PREFIX: &str = "creditchain-node-0-genesis";
pub const VALIDATOR_0_DATA_PERSISTENT_VOLUME_CLAIM_PREFIX: &str = "creditchain-node-0-validator";

...
use creditchain_config::config::{BootstrappingMode, ContinuousSyncingMode, NodeConfig};
use creditchain_forge::{LocalSwarm, NodeExt};
...
async fn test_fullnode_output_sync_epoch_changes() {
    ...
    vfn_config.state_sync.creditchain_data_client.use_compression = true;
...
async fn test_fullnode_output_sync_no_compression() {
    ...
    vfn_config
        ...
        .state_sync_driver
        .continuous_syncing_mode = ContinuousSyncingMode::ApplyTransactionOutputs;
    vfn_config.state_sync.creditchain_data_client.use_compression = false;
...
async fn test_fullnode_output_sync_exponential_backoff() {
    ...
    vfn_config
        ...
        .state_sync_driver
        .continuous_syncing_mode = ContinuousSyncingMode::ApplyTransactionOutputs;
    vfn_config.state_sync.creditchain_data_client.response_timeout_ms = 1;
...
async fn test_validator_fast_sync_no_compression() {
    ...
    let mut swarm = SwarmBuilder::new_local(4)
        ...
        .with_init_config(Arc::new(|_, config, _| {
            ...
            config.state_sync.state_sync_driver.continuous_syncing_mode =
                ContinuousSyncingMode::ApplyTransactionOutputs;
            config.state_sync.creditchain_data_client.use_compression = false;
        }))
        .build()
        .await;
    ...
    let mut swarm = SwarmBuilder::new_local(4)
        ...
        .with_init_config(Arc::new(|_, config, _| {
            ...
            config
                ...
                .creditchain_data_client
                .max_num_output_reductions = 1;
            config.state_sync.creditchain_data_client.response_timeout_ms = 1;
        }))
        .build()
        .await;

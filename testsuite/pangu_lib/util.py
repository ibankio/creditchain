...
NODE_CONFIG_MOUNT_NAME: str = "creditchain-config"
NODE_CONFIG_MOUNT_PATH: str = "/opt/creditchain/etc"
GENESIS_ARTIFACTS_MOUNT_NAME: str = "genesis-config"
GENESIS_ARTIFACTS_MOUNT_PATH: str = "/opt/creditchain/genesis"
NODE_IDENTITY_MOUNT_NAME: str = "aptos-secret"
NODE_IDENTITY_MOUNT_PATH: str = "/opt/creditchain/identites"
...
CREDITCHAIN_DATA_NAME: str = "creditchain-data"
CREDITCHAIN_DATA_DIR: str = "/opt/creditchain/data"

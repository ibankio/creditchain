...
use creditchain_config::config::{ConsensusConfig, ConsensusObserverConfig};
...
struct BufferManagerHandle {
    ...
    pub commit_tx:
        Option<creditchain_channel::Sender<AccountAddress, (AccountAddress, IncomingCommitRequest)>>,
...
impl BufferManagerHandle {
    ...
    pub fn init(
        ...
        commit_tx: creditchain_channel::Sender<AccountAddress, (AccountAddress, IncomingCommitRequest)>,
...
impl ExecutionProxyClient {
    ...
    fn spawn_decoupled_execution(
        ...
        let (commit_msg_tx, commit_msg_rx) =
            creditchain_channel::new::<AccountAddress, (AccountAddress, IncomingCommitRequest)>(
                QueueStyle::FIFO,
                100,

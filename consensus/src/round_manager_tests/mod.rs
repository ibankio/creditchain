...
pub struct NodeSetup {
    ...
    processed_opt_proposal_rx: creditchain_channels::UnboundedReceiver<OptBlockData>,
...
impl NodeSetup {
    ...
    fn new(
        ...
        let (opt_proposal_loopback_tx, opt_proposal_loopback_rx) = creditchain_channels::new_unbounded(

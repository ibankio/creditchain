...
impl From<creditchain_secure_storage::Error> for Error {
    fn from(error: creditchain_secure_storage::Error) -> Self {
        match error {
            creditchain_secure_storage::Error::PermissionDenied => {
            ...
            creditchain_secure_storage::Error::KeyVersionNotFound(_, _)
            | creditchain_secure_storage::Error::KeyNotSet(_) => {

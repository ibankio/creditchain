...
use creditchain_dkg_runtime::{start_dkg_runtime, DKGMessage};
use creditchain_event_notifications::{
    DbBackedOnChainConfig, EventNotificationListener, ReconfigNotificationListener,
};
use creditchain_jwk_consensus::{start_jwk_consensus_runtime, types::JWKConsensusMsg};
...
fn create_consensus_publisher(
    ...
    let runtime = creditchain_runtimes::spawn_named_runtime("publisher".into(), None);
...
fn create_observer_network_handler(
    ...
    let consensus_observer_runtime = creditchain_runtimes::spawn_named_runtime("observer".into(), None);

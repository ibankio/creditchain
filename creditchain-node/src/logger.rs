...
use creditchain_logger::{
    creditchain_logger::FileWriter, info, telemetry_log_writer::TelemetryLog, LoggerFilterUpdater,
};
...
pub fn create_logger(
    ...
    let mut logger_builder = creditchain_logger::Logger::builder();
...
fn log_config_and_build_information(node_config: &NodeConfig) {
    ...
    // with the features defined in the creditchain-node Cargo.toml file.

...
impl RSA_JWK {
    ...
    // The private key to this JWK is found under INTERNAL_TEST_OIDC_PROVIDER_PRIVATE_KEY in creditchain-keyless-prod in gcloud secrets
    ...
    // TODO(keyless): Move this to creditchain-crypto so other services can use this

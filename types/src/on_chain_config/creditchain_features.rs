...
pub enum FeatureFlag {
    ...
    CREDITCHAIN_STD_CHAIN_ID_NATIVES = 4,
    ...
    CREDITCHAIN_UNIQUE_IDENTIFIERS = 23,
...
impl FeatureFlag {
    pub fn default_features() -> Vec<Self> {
        vec![
            ...
            FeatureFlag::CREDITCHAIN_STD_CHAIN_ID_NATIVES,
            ...
            FeatureFlag::CREDITCHAIN_UNIQUE_IDENTIFIERS,
...
pub fn creditchain_test_feature_flags_genesis() -> ChangeSet {

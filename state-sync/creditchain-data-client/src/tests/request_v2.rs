...
use crate::{
    ...
    interface::{CreditChainDataClientInterface, SubscriptionRequestMetadata},
    priority::PeerPriority,
    tests::{mock::MockNetwork, utils},
};
use creditchain_config::{config::CreditChainDataClientConfig, network_id::NetworkId};
...
fn create_creditchain_data_client(use_request_v2: bool) -> CreditChainDataClientConfig {
    CreditChainDataClientConfig {
...
fn create_client_with_peer(use_request_v2: bool) -> (MockNetwork, CreditChainDataClient, NetworkId) {
    ...
    let data_client_config = create_creditchain_data_client(use_request_v2);

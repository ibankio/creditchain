...
use creditchain_config::{
    config::{CreditChainDataClientConfig, CreditChainDataMultiFetchConfig, CreditChainLatencyFilteringConfig},
    network_id::{NetworkId, PeerNetworkId},
};
use creditchain_storage_service_types::requests::{DataRequest, StorageServiceRequest};
...
async fn request_latency_filtering() {
    ...
    let data_client_config = CreditChainDataClientConfig {
        ...
        latency_filtering_config: CreditChainLatencyFilteringConfig {

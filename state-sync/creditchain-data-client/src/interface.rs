...
use creditchain_storage_service_types::{responses::TransactionOrOutputListWithProofV2, Epoch};
...
/// The API offered by the CreditChain Data Client.
#[async_trait]
pub trait CreditChainDataClientInterface {
...
/// A response error that users of the CreditChain Data Client can use to notify

...
/// An error returned by the CreditChain Data Client for failed API calls.
...
impl From<creditchain_storage_service_client::Error> for Error {
    fn from(error: creditchain_storage_service_client::Error) -> Self {

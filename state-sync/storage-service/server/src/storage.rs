...
use creditchain_storage_interface::{CreditChainDbError, DbReader, Result as StorageResult};
...
/// The interface into local storage (e.g., the CreditChain DB) used by the storage
...
pub trait StorageReaderInterface: Clone + Send + 'static {
    ...
    fn get_data_summary(&self) -> creditchain_storage_service_types::Result<DataSummary, Error>;
    ...
    fn get_transactions_with_proof(
        ...
        end_version: u64,
        include_events: bool,
    ) -> creditchain_storage_service_types::Result<TransactionDataWithProofResponse, Error>;
    ...
    ) -> creditchain_storage_service_types::Result<EpochChangeProof, Error>;
    ...
    fn get_number_of_states(&self, version: u64)
        -> creditchain_storage_service_types::Result<u64, Error>;
    ...
    fn get_state_value_chunk_with_proof(
        ...
        start_index: u64,
        end_index: u64,
    ) -> creditchain_storage_service_types::Result<StateValueChunkWithProof, Error>;
}
...
impl StorageReader {
    ...
    ) -> creditchain_storage_service_types::Result<Option<CompleteDataRange<Version>>, Error> {
    ...
    ($(
        ...
        $(
            ...
            fn $name(&self, $($arg: $ty),*) -> $return_type {
                ...
                result.map_err(|e| CreditChainDbError::Other(e.to_string()))
            }
        )+
    };
}
...
/// `end == u64::MAX`.
fn inclusive_range_len(start: u64, end: u64) -> creditchain_storage_service_types::Result<u64, Error> {
    // len = end - start + 1
...
) -> creditchain_storage_service_types::Result<(bool, u64), Error> {

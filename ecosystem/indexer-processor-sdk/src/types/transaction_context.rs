...
pub struct TransactionMetadata {
    ...
    pub end_version: u64,
    pub start_transaction_timestamp: Option<creditchain_protos::util::timestamp::Timestamp>,
    pub end_transaction_timestamp: Option<creditchain_protos::util::timestamp::Timestamp>,

...
use anyhow::Error;
use creditchain_protos::transaction::v1::{move_type::Content, Event};
...
/// Example:
/// ```
/// use creditchain_transaction_filter::{EventFilterBuilder, MoveStructTagFilterBuilder};
///
...
impl From<creditchain_protos::indexer::v1::EventFilter> for EventFilter {
    fn from(proto_filter: creditchain_protos::indexer::v1::EventFilter) -> Self {
        Self {
...
impl From<EventFilter> for creditchain_protos::indexer::v1::EventFilter {

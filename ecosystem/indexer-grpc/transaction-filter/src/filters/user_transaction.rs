...
/// Example:
/// ```
/// use creditchain_transaction_filter::UserTransactionFilterBuilder;
///
...
impl From<creditchain_protos::indexer::v1::UserTransactionFilter> for UserTransactionFilter {
    fn from(proto_filter: creditchain_protos::indexer::v1::UserTransactionFilter) -> Self {
        Self {
...
impl From<UserTransactionFilter> for creditchain_protos::indexer::v1::UserTransactionFilter {
...
/// Example:
/// ```
/// use creditchain_transaction_filter::EntryFunctionFilterBuilder;
///
...
impl From<creditchain_protos::indexer::v1::EntryFunctionFilter> for EntryFunctionFilter {
    fn from(proto_filter: creditchain_protos::indexer::v1::EntryFunctionFilter) -> Self {
        Self {
...
impl From<EntryFunctionFilter> for creditchain_protos::indexer::v1::EntryFunctionFilter {
...
/// Example:
/// ```
/// use creditchain_transaction_filter::{EntryFunctionFilterBuilder, UserTransactionPayloadFilterBuilder};
///
...
impl From<creditchain_protos::indexer::v1::UserTransactionPayloadFilter>
    for UserTransactionPayloadFilter
{
    fn from(proto_filter: creditchain_protos::indexer::v1::UserTransactionPayloadFilter) -> Self {
        Self {
...
impl From<UserTransactionPayloadFilter>
    for creditchain_protos::indexer::v1::UserTransactionPayloadFilter
{

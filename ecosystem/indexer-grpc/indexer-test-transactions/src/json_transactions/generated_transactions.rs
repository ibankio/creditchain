...
pub const IMPORTED_MAINNET_TXNS_602320562_TOKEN_V2_CREDITCHAIN_TOKEN_MINT: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/602320562_token_v2_creditchain_token_mint.json"
    ));
...
pub const ALL_IMPORTED_MAINNET_TXNS: &[&[u8]] = &[
    ...
    IMPORTED_MAINNET_TXNS_602320562_TOKEN_V2_CREDITCHAIN_TOKEN_MINT,

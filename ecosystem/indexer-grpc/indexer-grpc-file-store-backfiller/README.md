...
* A running archival fullnode with `index` enabled. You can check more in [CreditChain docs](https://github.com/ibankio/creditchain/tree/main/docs) and [fullnode config](https://github.com/ibankio/creditchain/tree/main/ecosystem/indexer-grpc/indexer-grpc-fullnode).

...
3. `tools`: Image containing all the libra2 tools binaries including `libra2-debugger`, `libra2`, `libra2-transaction-emitter`, `libra2-openapi-spec-generator` and `libra2-fn-check-client`. Also, includes the CreditChain Move framework for use with genesis generation.

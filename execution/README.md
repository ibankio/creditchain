...
id: executor
title: Executor
custom_edit_url: https://github.com/ibankio/creditchain/edit/main/executor/README.md
---


## Overview

The CreditChain Blockchain is a replicated state machine. Each validator is a replica
...
in the CreditChain Node config file for it to work, but can leave other entries
default by not specifying them.

```yaml
execution:
    # see https://github.com/ibankio/creditchain/blob/main/config/src/config/test_data/public_full_node.yaml
    # for explanation

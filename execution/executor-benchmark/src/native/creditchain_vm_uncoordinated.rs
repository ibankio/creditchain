...
use creditchain_vm::{CreditChainVM, VMBlockExecutor};
...
pub struct CreditChainVMParallelUncoordinatedBlockExecutor;

impl VMBlockExecutor for CreditChainVMParallelUncoordinatedBlockExecutor {
    fn new() -> Self {
        Self
    }

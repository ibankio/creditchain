...
impl CommonStructTags {
    pub fn new() -> Self {
        Self {
            ...
            apt_coin_store: CoinStoreResource::<CreditChainCoinType>::struct_tag(),
            ...
            apt_coin_type_name: "0x1::creditchain_coin::CreditChainCoin".to_string(),
            apt_coin_info_resource: StateKey::resource_typed::<CoinInfoResource<CreditChainCoinType>>(
                &CreditChainCoinType::coin_info_address(),
            )
            .unwrap(),
        }
    }
...
impl DbAccessUtil {
    ...
    pub fn new_state_key_creditchain_coin(&self, address: &AccountAddress) -> StateKey {
    ...
    pub fn get_apt_coin_store(
        ...
        state_view: &impl StateView,
    ) -> Result<Option<CoinStoreResource<CreditChainCoinType>>> {
    ...
    pub fn new_apt_coin_store(
        balance: u64,
        address: AccountAddress,
    ) -> CoinStoreResource<CreditChainCoinType> {

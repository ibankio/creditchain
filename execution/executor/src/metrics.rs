...
use creditchain_logger::{prelude::*, sample, warn};
...
pub static EXECUTE_CHUNK: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_execute_chunk_seconds",
        // metric description
        "The time spent in seconds of chunk execution in CreditChain executor",
...
pub static APPLY_CHUNK: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_apply_chunk_seconds",
        // metric description
        "The time spent in seconds of applying txn output chunk in CreditChain executor",
        exponential_buckets(/*start=*/ 1e-3, /*factor=*/ 2.0, /*count=*/ 20).unwrap(),
    )
    .unwrap()
});
...
pub static COMMIT_CHUNK: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_commit_chunk_seconds",
        // metric description
        "The time spent in seconds of committing chunk in CreditChain executor",
        exponential_buckets(/*start=*/ 1e-3, /*factor=*/ 2.0, /*count=*/ 20).unwrap(),
    )
    .unwrap()
});
...
pub static GET_BLOCK_EXECUTION_OUTPUT_BY_EXECUTING: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_get_block_execution_output_by_executing_seconds",
        // metric description
...
pub static OTHER_TIMERS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        // metric name
        "creditchain_executor_other_timers_seconds",
        // metric description
        "The time spent in seconds of others in CreditChain executor",
        &["name"],
        exponential_buckets(/*start=*/ 1e-3, /*factor=*/ 2.0, /*count=*/ 20).unwrap(),
    )
    .unwrap()
...
pub static EXECUTOR_ERRORS: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!("creditchain_executor_error_total", "Cumulative number of errors").unwrap()
});

pub static BLOCK_EXECUTION_WORKFLOW_WHOLE: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_block_execution_workflow_whole_seconds",
        // metric description
        "The total time spent in seconds in executing execute_and_state_checkpoint in the BlockExecutorInner.",
        exponential_buckets(/*start=*/ 1e-3, /*factor=*/ 2.0, /*count=*/ 20).unwrap(),
    )
...
pub static UPDATE_LEDGER: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_ledger_update_seconds",
        // metric description
...
pub static CHUNK_OTHER_TIMERS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        // metric name
        "creditchain_chunk_executor_other_seconds",
        // metric description
...
pub static VM_EXECUTE_CHUNK: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_vm_execute_chunk_seconds",
        // metric description
...
pub static COMMIT_BLOCKS: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_commit_blocks_seconds",
        // metric description
        "The total time spent in seconds of commiting blocks in CreditChain executor ",
        exponential_buckets(/*start=*/ 1e-3, /*factor=*/ 2.0, /*count=*/ 20).unwrap(),
    )
    .unwrap()
});
...
pub static SAVE_TRANSACTIONS: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_save_transactions_seconds",
        // metric description
        "The time spent in seconds of calling save_transactions to storage in CreditChain executor",
        exponential_buckets(/*start=*/ 1e-3, /*factor=*/ 2.0, /*count=*/ 20).unwrap(),
    )
    .unwrap()
});
...
pub static TRANSACTIONS_SAVED: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "creditchain_executor_transactions_saved",
        // metric description
        "The number of transactions saved to storage in CreditChain executor"
    )
    .unwrap()
});
...
pub static PROCESSED_TXNS_COUNT: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_processed_txns_count",
...
pub static PROCESSED_FAILED_TXNS_REASON_COUNT: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_processed_failed_txns_reason_count",
        "Count of the transactions since last restart. state is success, failed or retry",
...
pub static PROCESSED_USER_TXNS_BY_PAYLOAD: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_processed_user_transactions_by_payload",
...
pub static PROCESSED_USER_TXNS_ENTRY_FUNCTION_BY_MODULE: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_processed_user_transactions_entry_function_by_module",
...
pub static PROCESSED_USER_TXNS_ENTRY_FUNCTION_BY_CORE_METHOD: Lazy<IntCounterVec> =
    Lazy::new(|| {
        register_int_counter_vec!(
            "creditchain_processed_user_transactions_entry_function_by_core_method",
...
pub static PROCESSED_USER_TXNS_CORE_EVENTS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_processed_user_transactions_core_events",
        "Counter of processed EntryFunction user transaction for core address by method",
...
pub static PROCESSED_TXNS_OUTPUT_SIZE: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        "creditchain_processed_txns_output_size",
...
pub static PROCESSED_TXNS_NUM_AUTHENTICATORS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        "creditchain_processed_txns_num_authenticators",
...
pub static PROCESSED_TXNS_AUTHENTICATOR: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_processed_txns_authenticator",
...
pub static CONCURRENCY_GAUGE: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        "creditchain_executor_call_concurrency",
...
{
    let detailed_counters = CreditChainVM::get_processed_transactions_detailed_counters();

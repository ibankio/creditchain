...
This chart is relatively generic and contains very little CreditChain specific logic, except for some minor transforms under files/vector-transforms.yaml.

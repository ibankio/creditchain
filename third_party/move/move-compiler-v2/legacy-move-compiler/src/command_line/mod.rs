...
pub const WARN_OF_DEPRECATION_USE_IN_CREDITCHAIN_LIBS: &str = "WARN_OF_DEPRECATION_USE_IN_CREDITCHAIN_LIBS";
pub const WARN_OF_DEPRECATION_USE_IN_CREDITCHAIN_LIBS_FLAG: &str = "Wdeprecation-aptos";

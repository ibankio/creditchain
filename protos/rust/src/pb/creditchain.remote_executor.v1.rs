...
/// Encoded file descriptor set for the `creditchain.remote_executor.v1` package
...
include!("creditchain.remote_executor.v1.serde.rs");
include!("creditchain.remote_executor.v1.tonic.rs");

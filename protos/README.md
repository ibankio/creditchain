# Protos
This directory contains the protobuf definitions for all CreditChain services. For the sake of simplifying release and minimizing potential version conflicts, we include all protos and code generated from those protos in one place.

...
//! This module defines representation of CreditChain core data structures at physical level via schemas
...
#[cfg(feature = "fuzzing")]
pub mod fuzzing {
    use creditchain_schemadb::schema::fuzzing::assert_no_panic_decoding;

...
use anyhow::Result;
use creditchain_jellyfish_merkle::node_type::NodeKey;
use creditchain_schemadb::{
    define_schema,
    schema::{KeyCodec, SeekKeyCodec, ValueCodec},
};
use creditchain_types::{state_store::state_key::StateKey, transaction::Version};
use byteorder::{BigEndian, WriteBytesExt};
use std::mem::size_of;

type Node = creditchain_jellyfish_merkle::node_type::Node<StateKey>;

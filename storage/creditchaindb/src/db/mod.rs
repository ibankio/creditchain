...
use creditchain_db_indexer::{db_indexer::InternalIndexerDB, Indexer};
...
use creditchain_storage_interface::{
    db_ensure as ensure, db_other_bail as bail, CreditChainDbError, DbReader, DbWriter, LedgerSummary,
...
#[cfg(test)]
mod creditchaindb_test;
#[cfg(any(test, feature = "fuzzing"))]
pub mod test_helper;

/// This holds a handle to the underlying DB responsible for physical storage and provides APIs for
/// access to the core CreditChain data structures.
pub struct CreditChainDB {
...
include!("include/creditchaindb_reader.rs");
// DbWriter implementations and private functions used by them.
include!("include/creditchaindb_writer.rs");
// Other private methods.
include!("include/creditchaindb_internal.rs");
// Testonly methods.
#[cfg(any(test, feature = "fuzzing", feature = "consensus-only-perf-test"))]
include!("include/creditchaindb_testonly.rs");

#[cfg(feature = "consensus-only-perf-test")]
pub mod fake_creditchaindb;
...
impl CreditChainDB {
    ...
    pub fn create_checkpoint(
        ...
        info!(sharding = sharding, "Creating checkpoint for CreditChainDB.");

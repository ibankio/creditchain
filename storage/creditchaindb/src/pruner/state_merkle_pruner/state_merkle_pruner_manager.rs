...
use creditchain_config::config::StateMerklePrunerConfig;
use creditchain_jellyfish_merkle::StaleNodeIndex;
use creditchain_schemadb::schema::KeyCodec;
use creditchain_storage_interface::Result;
use creditchain_types::transaction::{AtomicVersion, Version};
use std::{
    marker::PhantomData,
    sync::{atomic::Ordering, Arc},
};

/// The `Pruner` is meant to be part of a `CreditChainDB` instance and runs in the background to prune old
/// data.
///

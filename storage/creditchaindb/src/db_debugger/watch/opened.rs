...
use crate::{db_debugger::ShardingConfig, CreditChainDB};
use creditchain_config::config::StorageConfig;
...
impl Cmd {
    pub fn run(self) -> Result<()> {
        ...
        .expect("Failed to open CreditChainDB");

        println!("CreditChainDB opened. Kill to exit.");

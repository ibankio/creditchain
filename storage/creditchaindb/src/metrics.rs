...
pub static LEDGER_COUNTER: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        // metric name
        "creditchain_storage_ledger",
        // metric description
        "CreditChain storage ledger counters",
...
pub static COMMITTED_TXNS: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "creditchain_storage_committed_txns",
        "CreditChain storage committed transactions"
    )
    .unwrap()
});
...
pub static LATEST_TXN_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_storage_latest_transaction_version",
        "CreditChain storage latest transaction version"
    )
    .unwrap()
});
...
pub static LEDGER_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_storage_ledger_version",
...
pub static NEXT_BLOCK_EPOCH: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_storage_next_block_epoch",
...
pub static STATE_ITEMS: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!("creditchain_storage_state_items", "Total number of state items.").unwrap()
});

pub static TOTAL_STATE_BYTES: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_storage_total_state_bytes",
...
pub static PRUNER_WINDOW: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        // metric name
        "creditchain_storage_prune_window",
        // metric description
        "CreditChain storage prune window",
        // metric labels (dimensions)
        &["pruner_name",]
    )
    .unwrap()
...
pub static PRUNER_VERSIONS: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        // metric name
        "creditchain_pruner_versions",
        // metric description
        "CreditChain pruner versions",
        // metric labels (dimensions)
        &["pruner_name", "tag"]
    )
    .unwrap()
...
pub static API_LATENCY_SECONDS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        // metric name
        "creditchain_storage_api_latency_seconds",
        // metric description
        "CreditChain storage api latency in seconds",
        // metric labels (dimensions)
        &["api_name", "result"],
...
pub static OTHER_TIMERS_SECONDS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        // metric name
        "creditchain_storage_other_timers_seconds",
        // metric description
...
pub static NODE_CACHE_SECONDS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        // metric name
        "creditchain_storage_node_cache_seconds",
        // metric description
...
pub static ROCKSDB_PROPERTIES: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        // metric name
        "creditchain_rocksdb_properties",
        // metric description
...
pub static ROCKSDB_SHARD_PROPERTIES: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        // metric name
        "creditchain_rocksdb_shard_properties",
        // metric description
...
pub(crate) static LATEST_SNAPSHOT_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_storage_latest_state_snapshot_version",
...
pub(crate) static LATEST_CHECKPOINT_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_storage_latest_state_checkpoint_version",
...
pub(crate) static BACKUP_EPOCH_ENDING_EPOCH: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_backup_handler_epoch_ending_epoch",
...
pub(crate) static BACKUP_TXN_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_backup_handler_transaction_version",
...
pub(crate) static BACKUP_STATE_SNAPSHOT_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_backup_handler_state_snapshot_version",
...
pub(crate) static BACKUP_STATE_SNAPSHOT_LEAF_IDX: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_backup_handler_state_snapshot_leaf_index",
...
pub static BACKUP_TIMER: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        "creditchain_backup_handler_timers_seconds",
...
pub static CONCURRENCY_GAUGE: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        "creditchain_storage_api_concurrency",
...
pub static GAUGE: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!("creditchain_storage_gauge", "Various gauges", &["name"]).unwrap()
});

pub static COUNTER: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        // metric name
        "creditchain_storage_counter",
        // metric description
        "Various counters for CreditChain DB / storage.",
        // metric labels (dimensions)
        &["name"],
    )
    .unwrap()

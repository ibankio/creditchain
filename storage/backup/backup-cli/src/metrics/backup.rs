...
pub static HEARTBEAT_TS: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_db_backup_coordinator_heartbeat_timestamp_s",
...
pub static EPOCH_ENDING_EPOCH: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_db_backup_coordinator_epoch_ending_epoch",
...
pub static STATE_SNAPSHOT_EPOCH: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_db_backup_coordinator_state_snapshot_epoch",
...
pub static TRANSACTION_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_db_backup_coordinator_transaction_version",
...
pub static COMPACTED_TXN_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "creditchain_db_backup_coordinator_compacted_version",
...
pub static BACKUP_TIMER: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        "creditchain_db_backup_timers_seconds",
...
pub static THROUGHPUT_COUNTER: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_db_backup_received_bytes",

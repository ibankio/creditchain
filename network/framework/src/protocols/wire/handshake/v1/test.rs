...
fn ignore_unknown_protocols() {
    ...
    let some_unknown_protos = ProtocolIdSet(creditchain_bitvec::BitVec::from_iter([
    ...
    let all_unknown_protos = ProtocolIdSet(creditchain_bitvec::BitVec::from_iter([42, 99, 123]));

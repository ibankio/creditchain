...
mod test {
    ...
    use creditchain_crypto::{test_utils::TEST_SEED, traits::Uniform as _, x25519};
    ...
    fn build_peers() -> (
        ...
        let client_peer_id = creditchain_types::account_address::from_identity_public_key(client_public);
        ...
        let server_peer_id = creditchain_types::account_address::from_identity_public_key(server_public);

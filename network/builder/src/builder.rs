...
use creditchain_event_notifications::{DbBackedOnChainConfig, EventSubscriptionService};
use creditchain_logger::prelude::*;
use creditchain_netcore::transport::tcp::TCPBufferCfg;
...
use creditchain_network_discovery::DiscoveryChangeListener;
use creditchain_time_service::TimeService;
use creditchain_types::{chain_id::ChainId, network_address::NetworkAddress};
...
impl NetworkBuilder {
    ...
    pub fn conn_mgr_reqs_tx(&self) -> Option<creditchain_channels::Sender<ConnectivityRequest>> {

...
use creditchain_crypto_derive::{key_name, DeserializeKey, SerializeKey, SilentDebug, SilentDisplay};
...
impl Uniform for PrivateKey {
    ...
    // Uses a hack to get around the incompatability of the `creditchain-crypto` RngCore trait and the

...
//! ```
//! use std::iter::zip;
//! use creditchain_crypto::test_utils::{KeyPair, TestCreditChainCrypto};
//! use creditchain_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use creditchain_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use creditchain_crypto::bls12381::ProofOfPossession;
//! use creditchain_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/creditchain-crypto/src/test_utils.rs`:
//! //
...
//! let message = TestCreditChainCrypto("test".to_owned());
...
//! use creditchain_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use creditchain_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use creditchain_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use creditchain_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use creditchain_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/creditchain-crypto/`
...
//! // signature on TestCreditChainCrypto("test".to_owned())
...
//! ```
//! use std::iter::zip;
//! use creditchain_crypto::test_utils::KeyPair;
//! use creditchain_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use creditchain_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use creditchain_crypto::bls12381::ProofOfPossession;
//! use creditchain_crypto_derive::{CryptoHasher, BCSCryptoHash};

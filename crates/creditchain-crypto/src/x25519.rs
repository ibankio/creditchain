...
//!
//! ```
//! use creditchain_crypto::{x25519, Uniform, test_utils::TEST_SEED};
...
//! use creditchain_crypto::traits::ValidCryptoMaterialStringExt;
//! # fn main() -> Result<(), creditchain_crypto::traits::CryptoMaterialError> {

...
) -> impl Strategy<Value = (EdwardsPoint, EdwardsPoint, TestCreditChainCrypto)> {
    (
...
pub struct TestCreditChainCrypto(pub String);
...
// #[cfg(any(test, feature = "fuzzing"))]
pub struct TestCreditChainCryptoHasher(crate::hash::DefaultHasher);
// #[cfg(any(test, feature = "fuzzing"))]
impl ::core::clone::Clone for TestCreditChainCryptoHasher {
    #[inline]
    fn clone(&self) -> TestCreditChainCryptoHasher {
        match *self {
            TestCreditChainCryptoHasher(ref __self_0_0) => {
                TestCreditChainCryptoHasher(::core::clone::Clone::clone(__self_0_0))
            },
        }
    }
}
...
// #[cfg(any(test, feature = "fuzzing"))]
impl TestCreditChainCryptoHasher {
    fn new() -> Self {
        let name = crate::_serde_name::trace_name::<TestCreditChainCrypto>()
            .expect("The `CryptoHasher` macro only applies to structs and enums");
        TestCreditChainCryptoHasher(crate::hash::DefaultHasher::new(name.as_bytes()))
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
static TEST_CRYPTO_HASHER: crate::_once_cell::sync::Lazy<TestCreditChainCryptoHasher> =
    crate::_once_cell::sync::Lazy::new(TestCreditChainCryptoHasher::new);
// #[cfg(any(test, feature = "fuzzing"))]
impl std::default::Default for TestCreditChainCryptoHasher {
    fn default() -> Self {
        TEST_CRYPTO_HASHER.clone()
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHasher for TestCreditChainCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl std::io::Write for TestCreditChainCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHash for TestCreditChainCrypto {
    type Hasher = TestCreditChainCryptoHasher;

    fn hash(&self) -> crate::hash::HashValue {
        use crate::hash::CryptoHasher;
        let mut state = Self::Hasher::default();
        bcs::serialize_into(&mut state, &self)
            .expect("BCS serialization of TestCreditChainCrypto should not fail");
        state.finish()
    }
}

/// Produces a random TestCreditChainCrypto signable / verifiable struct.
#[cfg(any(test, feature = "fuzzing"))]
pub fn random_serializable_struct() -> impl Strategy<Value = TestCreditChainCrypto> {
    (String::arbitrary()).prop_map(TestCreditChainCrypto).no_shrink()
}

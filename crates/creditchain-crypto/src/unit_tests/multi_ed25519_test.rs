...
use crate::{
    ...
    test_utils::{TestCreditChainCrypto, TEST_SEED},
    traits::*,
...
static MESSAGE: Lazy<TestCreditChainCrypto> = Lazy::new(|| TestCreditChainCrypto("Test Message".to_string()));
fn message() -> &'static TestCreditChainCrypto {
    &MESSAGE
}
...
fn test_sample_multisig() {
    ...
    println!("let msg = b\"Hello CreditChain!\";");
    print!("//let ks = vector[");
    for k in ks {
        print!("{k}, ")
    }

...
use creditchain_crypto_derive::{DeserializeKey, SerializeKey, SilentDebug, SilentDisplay};
...
impl Ed25519PrivateKey {
    ...
    /// TODO: We are temporarily breaking the abstraction here and exposing the SK scalar. In the future, we should add traits for encryption inside creditchain-crypto so that we can both sign and decrypt with an Ed25519PrivateKey.

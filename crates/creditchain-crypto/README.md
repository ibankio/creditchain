...
id: crypto
title: Crypto
custom_edit_url: https://github.com/ibankio/creditchain/edit/main/crypto/crypto/README.md
---

The crypto component hosts all the implementations of cryptographic primitives we use in CreditChain: hashing, signatures, multisignatures, aggregate signatures, and key derivation/generation.
...
CreditChain makes use of several cryptographic algorithms:

...
use creditchain_crypto::{bls12381::PrivateKey, SigningKey};
...
pub struct KeyLevelConsensusManager {
    ...
    qc_update_tx: creditchain_channel::Sender<(Issuer, KID), QuorumCertifiedUpdate>,
    qc_update_rx: creditchain_channel::Receiver<(Issuer, KID), QuorumCertifiedUpdate>,
...
impl KeyLevelConsensusManager {
    pub fn new(
        ...
        let (qc_update_tx, qc_update_rx) = creditchain_channel::new(QueueStyle::KLAST, 1, None);
        Self {
            consensus_key,
            my_addr,
            epoch_state,
...
impl TConsensusManager for KeyLevelConsensusManager {
    async fn run(
        ...
        mut jwk_updated_rx: creditchain_channel::Receiver<(), ObservedJWKsUpdated>,
        mut rpc_req_rx: creditchain_channel::Receiver<
            AccountAddress,
        ...
        let (local_observation_tx, mut local_observation_rx) =
            creditchain_channel::new(QueueStyle::KLAST, 100, None);

...
use creditchain_jwk_utils::{fetch_jwks_from_jwks_uri, fetch_jwks_uri_from_openid_config};
use creditchain_logger::{debug, info};
use creditchain_types::jwks::{jwk::JWK, Issuer};
...
impl JWKObserver {
    pub fn spawn(
        ...
        observation_tx: creditchain_channel::Sender<(), (Issuer, Vec<JWK>)>,
    ) -> Self {

...
impl FirebaseJwtVerifier {
    ...
    pub async fn validate_jwt(&self, headers: Arc<HeaderMap>) -> Result<String, CreditChainTapError> {
        ...
        let token_data = match verify.await {
            ...
            None => {
                return Err(CreditChainTapError::new(
                    ...
                    CreditChainTapErrorCode::AuthTokenInvalid,
                ));
            },
        };
...
pub fn jwt_sub(headers: Arc<HeaderMap>) -> Result<String, CreditChainTapError> {
    let is_jwt = headers
        .get(X_IS_JWT_HEADER)
        ...
        .and_then(|v| v.split_whitespace().nth(1))
    {
        ...
        None => Err(CreditChainTapError::new(

...
/* tslint:disable */
/* eslint-disable */
import type { CreditChainTapError } from '../models/CreditChainTapError';
...
export class FundService {
    ...
    }): CancelablePromise<FundResponse | CreditChainTapError> {
    ...
    public isEligible({
        ...
        requestBody: FundRequest,
    }): CancelablePromise<any | CreditChainTapError> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/is_eligible',
            body: requestBody,

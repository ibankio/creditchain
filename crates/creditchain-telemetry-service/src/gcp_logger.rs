...
macro_rules! trace {
    ($($arg:tt)+) => {
        $crate::log!(creditchain_logger::Level::Trace, $($arg)+)
    };
}
...
macro_rules! debug {
    ($($arg:tt)+) => {
        $crate::log!(creditchain_logger::Level::Debug, $($arg)+)
    };
}
...
macro_rules! info {
    ($($arg:tt)+) => {
        $crate::log!(creditchain_logger::Level::Info, $($arg)+)
    };
}
...
macro_rules! warn {
    ($($arg:tt)+) => {
        $crate::log!(creditchain_logger::Level::Warn, $($arg)+)
    };
}
...
macro_rules! error {
    ($($arg:tt)+) => {
        $crate::log!(creditchain_logger::Level::Error, $($arg)+)
    };
}
...
macro_rules! log {
    ...
    ($level:expr, $($args:tt)+) => {{
        if let Some(trace_id) = $crate::gcp_logger::gcp_trace_id() {
            creditchain_logger::log!($level, "logging.googleapis.com/trace"=%trace_id, $($args)+)
        } else {
            creditchain_logger::log!($level, $($args)+)
        }
    }};
}

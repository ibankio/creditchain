...
use creditchain_crypto::{CryptoMaterialError, ValidCryptoMaterial, ValidCryptoMaterialStringExt};
use creditchain_crypto_derive::{DeserializeKey, SerializeKey};
...
impl Default for PublicParameters {
    /// Verifiably creates CreditChain-specific public parameters.
    fn default() -> Self {

...
use anyhow::bail;
use creditchain_crypto::{bls12381, CryptoMaterialError, Genesis, SigningKey, ValidCryptoMaterial};
...
const DAS_WEIGHTED_PVSS_FIAT_SHAMIR_DST: &[u8; 54] =
    b"CREDITCHAIN_DAS_WEIGHTED_PROVABLY_PVSS_FIAT_SHAMIR_DST";

...
//!
//!   - The type is outside of reach, e.g. in a crate in creditchain-core that is
...
mod test {
    ...
    fn test() {
        ...
        assert_eq!(
            That::parse_from_parameter("0x1::coin::CoinStore::%3C0x1::creditchain_coin::CreditChainCoin%3E")
                .unwrap()
                .0,

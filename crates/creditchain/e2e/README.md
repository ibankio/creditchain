...
The best place to look is the test framework working directory, by default `/tmp/creditchain-cli-tests`.
...
```
$ cat /tmp/creditchain-cli-tests/out/007_test_move_compile_script.stdout
{
  "Error": "Move compilation failed: Unable to resolve packages for package 'TwoByTwoTransfer': While resolving dependency 'CreditChainFramework' in package 'TwoByTwoTransfer': While processing dependency 'CreditChainFramework': Unable to find package manifest for 'CreditChainFramework' at \"Move.toml/move/scripts/two_by_two_transfer/../../../framework/creditchain-framework\""
}
```

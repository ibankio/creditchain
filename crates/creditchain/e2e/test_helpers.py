...
from creditchain_sdk.async_client import RestClient
from common import METRICS_PORT, NODE_PORT, AccountInfo, Network, build_image_name
from creditchain_sdk.account_address import AccountAddress
...
class RunHelper:
    ...
    def prepare_move(self):
        shutil.copytree(
            "../../../creditchain-move/move-examples/cli-e2e-tests",

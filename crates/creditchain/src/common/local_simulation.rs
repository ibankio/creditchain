...
use creditchain_gas_profiling::FrameName;
...
use creditchain_vm::{data_cache::AsMoveResolver, CreditChainVM};
...
use creditchain_vm_types::{
    module_and_script_storage::AsCreditChainCodeStorage, output::VMOutput, resolver::StateStorageView,
};
use move_core_types::vm_status::VMStatus;
use std::{path::Path, time::Instant};

pub fn run_transaction_using_debugger(
    debugger: &CreditChainDebugger,
    version: u64,

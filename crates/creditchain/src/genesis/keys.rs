...
pub struct SetValidatorConfiguration {
    ...
    /// Host and port pair for the validator e.g. 127.0.0.1:6180 or creditchain.io:6180
    #[clap(long)]
    pub(crate) validator_host: HostAndPort,

    /// Host and port pair for the fullnode e.g. 127.0.0.1:6180 or creditchain.io:6180
    #[clap(long)]

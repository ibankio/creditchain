...
use super::{creditchain::CreditChainUpdateTool, revela::RevelaUpdateTool};
use crate::{
...
#[derive(Subcommand)]
pub enum UpdateTool {
    CreditChain(CreditChainUpdateTool),
...
impl UpdateTool {
    pub async fn execute(self) -> CliResult {
        match self {
            UpdateTool::CreditChain(tool) => tool.execute_serialized().await,

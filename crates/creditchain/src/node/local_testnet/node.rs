...
use creditchain_config::config::{NodeConfig, DEFAULT_GRPC_STREAM_PORT};
use creditchain_node::{load_node_config, start_test_environment_node};
...
pub struct NodeArgs {
    ...
    #[clap(long, value_parser = creditchain_node::load_seed)]
...
impl NodeManager {
    ...
    pub fn new_with_config(
        ...
        node_config.indexer_table_info.table_info_service_mode = match run_txn_stream {
            ...
            true => creditchain_config::config::TableInfoServiceMode::IndexingOnly,
            false => creditchain_config::config::TableInfoServiceMode::Disabled,
        };

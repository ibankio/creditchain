...
use creditchain_framework::UPGRADE_POLICY_CUSTOM_FIELD;
...
pub fn register_package_hooks() {
    move_package::package_hooks::register_package_hooks(Box::new(CreditChainPackageHooks {}))
}

struct CreditChainPackageHooks {}

impl PackageHooks for CreditChainPackageHooks {

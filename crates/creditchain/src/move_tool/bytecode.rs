...
struct BytecodeMetadata {
    creditchain_metadata: Option<RuntimeModuleMetadataV1>,
...
impl BytecodeCommand {
    ...
    fn print_metadata(&self, bytecode_path: &Path) -> Result<String, CliError> {
        ...
        let metadata = if self.is_script {
            ...
            BytecodeMetadata {
                creditchain_metadata: get_metadata_from_compiled_code(&script),
            ...
            BytecodeMetadata {
                creditchain_metadata: get_metadata_from_compiled_code(&module),

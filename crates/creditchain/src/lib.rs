...
use creditchain_workspace_server::WorkspaceCommand;
...
#[derive(Parser)]
#[clap(name = "creditchain", author, version, propagate_version = true, styles = creditchain_cli_common::creditchain_cli_style())]
pub enum Tool {
    #[clap(subcommand)]

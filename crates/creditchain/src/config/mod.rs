...
use crate::{
    common::{
        types::{
            ...
            ProfileSummary, CREDITCHAIN_FOLDER_GIT_IGNORE, CONFIG_FOLDER, GIT_IGNORE,
        },
...
use creditchain_cli_common::generate_cli_completions;
...
/// Tool for interacting with configuration of the CreditChain CLI tool
///
...
impl CliCommand<()> for GenerateShellCompletions {
    ...
    async fn execute(self) -> CliTypedResult<()> {
        generate_cli_completions::<Tool>("creditchain", self.shell, self.output_file.as_path())

...
use creditchain_types::{CreditChainCoinType, CoinType as CoinTypeTrait};
use bigdecimal::BigDecimal;
use field_count::FieldCount;
use serde::{Deserialize, Serialize};
use std::collections::HashMap;

const GAS_FEE_EVENT: &str = "0x1::creditchain_coin::GasFeeEvent";
...
impl CoinActivity {
    ...
    fn get_gas_event(
        ...
        Self {
            ...
            coin_type: CreditChainCoinType::type_tag().to_canonical_string(),

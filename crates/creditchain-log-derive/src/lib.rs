...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::creditchain_logger::Value::from_serde };
    let from_display = quote! { ::creditchain_logger::Value::from_display };
    let from_debug = quote! { ::creditchain_logger::Value::from_debug };
    let key_new = quote! { ::creditchain_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::creditchain_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::creditchain_logger::Visitor) {
                #(#visits)*
            }
        }
    };

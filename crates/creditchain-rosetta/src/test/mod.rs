...
use creditchain_rest_client::creditchain_api_types::{ResourceGroup, TransactionOnChainData};
...
fn test_transaction(
    ...
    TransactionOnChainData {
        version,
        transaction: creditchain_types::transaction::Transaction::UserTransaction(
            creditchain_types::transaction::SignedTransaction::new(

...
use creditchain_rest_client::{creditchain_api_types::CreditChainErrorCode, error::RestError};
    ...
    fn from(err: RestError) -> Self {
        match err {
            RestError::Api(err) => match err.error.error_code {
                ...
                CreditChainErrorCode::ModuleNotFound => ApiError::ModuleNotFound(Some(err.error.message)),
                ...
                CreditChainErrorCode::BlockNotFound => ApiError::BlockNotFound(Some(err.error.message)),
                CreditChainErrorCode::StateValueNotFound => {
                    ApiError::StateValueNotFound(Some(err.error.message))
                },
                CreditChainErrorCode::VersionPruned => ApiError::VersionPruned(Some(err.error.message)),
                CreditChainErrorCode::BlockPruned => ApiError::BlockPruned(Some(err.error.message)),
                CreditChainErrorCode::InvalidInput => ApiError::InvalidInput(Some(err.error.message)),
                ...
                CreditChainErrorCode::VmError => ApiError::VmError(Some(err.error.message)),
                ...
                CreditChainErrorCode::MempoolIsFull => ApiError::MempoolIsFull(Some(err.error.message)),
                CreditChainErrorCode::WebFrameworkError => {
                    ApiError::InternalError(Some(err.error.message))
                },
                CreditChainErrorCode::BcsNotSupported => ApiError::InvalidInput(Some(err.error.message)),
                CreditChainErrorCode::InternalError => ApiError::InternalError(Some(err.error.message)),
                CreditChainErrorCode::ApiDisabled => ApiError::InternalError(Some(err.error.message)),
            },

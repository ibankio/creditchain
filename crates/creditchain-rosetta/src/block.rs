...
use creditchain_logger::{debug, trace};
...
async fn build_block(
    ...
    block: creditchain_rest_client::creditchain_api_types::BcsBlock,
    chain_id: ChainId,
...
async fn get_block_by_index(
    ...
    BlockIdentifier,
    creditchain_rest_client::creditchain_api_types::BcsBlock,
)> {
...
pub struct BlockRetriever {
    page_size: u16,
    rest_client: Arc<creditchain_rest_client::Client>,
}

impl BlockRetriever {
    pub fn new(page_size: u16, rest_client: Arc<creditchain_rest_client::Client>) -> Self {
        BlockRetriever {
            page_size,
            rest_client,
        }
    ...
    ) -> ApiResult<creditchain_rest_client::creditchain_api_types::BcsBlock> {

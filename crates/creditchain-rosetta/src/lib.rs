...
pub struct RosettaContext {
    ...
    rest_client: Option<Arc<creditchain_rest_client::Client>>,
...
impl RosettaContext {
    ...
    fn rest_client(&self) -> ApiResult<Arc<creditchain_rest_client::Client>> {
...
pub fn bootstrap(
    ...
    rest_client: Option<creditchain_rest_client::Client>,
    supported_currencies: HashSet<Currency>,
) -> anyhow::Result<tokio::runtime::Runtime> {
    let runtime = creditchain_runtimes::spawn_named_runtime("rosetta".into(), None);

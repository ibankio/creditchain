...
use creditchain_sdk::{move_types::language_storage::TypeTag, transaction_builder::TransactionFactory};
...
async fn construction_derive(
    ...
    // CreditChain Ed25519 authentication scheme
    let public_key: Ed25519PublicKey =
...
///
/// Only the original Ed25519 accounts on CreditChain are supported
///
        ...
        TransactionPayload::EntryFunction(inner) => {
            ...
            match (
                *module.address(),
                ...
                (AccountAddress::ONE, CREDITCHAIN_ACCOUNT_MODULE, CREATE_ACCOUNT_FUNCTION) => {
...
/// Parses 0x1::creditchain_account::create(auth_key: address)
...
/// Parses 0x1::creditchain_account::transfer(receiver: address, amount: u64)
...
/// or 0x1::creditchain_account::transfer_fungible_assets(metadata: address, receiver: address, amount: u64)

...
use creditchain_types::event::EventHandle;
use serde::{Deserialize, Serialize};

pub const ACCOUNT_MODULE: &str = "account";
pub const CREDITCHAIN_ACCOUNT_MODULE: &str = "creditchain_account";
pub const CREDITCHAIN_COIN_MODULE: &str = "creditchain_coin";
...
pub const CREDITCHAIN_COIN_RESOURCE: &str = "CreditChainCoin";

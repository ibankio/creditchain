...
use creditchain_rest_client::creditchain_api_types::U64;
...
/// [`creditchain_types::transaction::SignedTransaction`]
///
...
pub struct ConstructionCombineRequest {
    /// Network identifier describing the blockchain and the chain id
    pub network_identifier: NetworkIdentifier,
    /// A hex encoded, BCS encoded, [`creditchain_types::transaction::RawTransaction`]
...
pub struct ConstructionCombineResponse {
    /// A hex encoded, BCS encoded, [`creditchain_types::transaction::SignedTransaction`]
...
pub struct ConstructionDeriveRequest {
    /// Network identifier describing the blockchain and the chain id
    pub network_identifier: NetworkIdentifier,
    /// Public key to derive an [`creditchain_types::account_address::AccountAddress`] from
...
pub struct ConstructionDeriveResponse {
    /// The account identifier of the account if the [`creditchain_types::account_address::AccountAddress`] can be derived.
    ///
...
pub struct ConstructionParseRequest {
    /// Network identifier describing the blockchain and the chain id
    pub network_identifier: NetworkIdentifier,
    /// Whether the transaction is a [`creditchain_types::transaction::SignedTransaction`]
    /// or a [`creditchain_types::transaction::RawTransaction`]
    pub signed: bool,
    /// A hex encoded, BCS encoded [`creditchain_types::transaction::SignedTransaction`]
    /// or a [`creditchain_types::transaction::RawTransaction`]
...
pub struct ConstructionParseResponse {
    ...
    /// The signers of the transaction, if it was a [`creditchain_types::transaction::SignedTransaction`]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct ConstructionPayloadsRequest {
    ...
    pub operations: Vec<Operation>,
    /// Required information for building a [`creditchain_types::transaction::RawTransaction`]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ConstructionMetadata>,
    /// Public keys of those who will sign the eventual [`creditchain_types::transaction::SignedTransaction`]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub public_keys: Option<Vec<PublicKey>>,
}
...
pub struct ConstructionSubmitResponse {
    /// Hash of the submitted [`creditchain_types::transaction::SignedTransaction`]

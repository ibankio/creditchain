...
//!
//! Why have an CreditChain version of the Rosetta CLI?
//!
...
//!
//! We want users to use the CreditChain CLI over the Rosetta CLI because of the added complexity of a
//! proxy server.  So, we split it out so general users aren't confused.
//!
//! TODO: Make CreditChain CLI framework common among multiple CLIs

...
const ERROR_MESSAGE: &str = "Docker is not available, confirm it is installed and running. See https://docs.creditchain.io/guides/local-development-network#faq for assistance.";

...
pub(crate) const ENV_CREDITCHAIN_DISABLE_TELEMETRY: &str = "CREDITCHAIN_DISABLE_TELEMETRY";
pub(crate) const ENV_CREDITCHAIN_FORCE_ENABLE_TELEMETRY: &str = "CREDITCHAIN_FORCE_ENABLE_TELEMETRY";
pub(crate) const ENV_CREDITCHAIN_DISABLE_TELEMETRY_PUSH_METRICS: &str =
    "CREDITCHAIN_DISABLE_TELEMETRY_PUSH_METRICS";
pub(crate) const ENV_CREDITCHAIN_DISABLE_TELEMETRY_PUSH_LOGS: &str = "CREDITCHAIN_DISABLE_TELEMETRY_PUSH_LOGS";
pub(crate) const ENV_CREDITCHAIN_DISABLE_TELEMETRY_PUSH_EVENTS: &str =
    "CREDITCHAIN_DISABLE_TELEMETRY_PUSH_EVENTS";
pub(crate) const ENV_CREDITCHAIN_DISABLE_PROMETHEUS_NODE_METRICS: &str =
    "CREDITCHAIN_DISABLE_PROMETHEUS_NODE_METRICS";
pub(crate) const ENV_CREDITCHAIN_DISABLE_LOG_ENV_POLLING: &str = "CREDITCHAIN_DISABLE_LOG_ENV_POLLING";
...
pub(crate) const CREDITCHAIN_GA_MEASUREMENT_ID: &str = "G-ZX4L6WPCFZ";
pub(crate) const CREDITCHAIN_GA_API_SECRET: &str = "ArtslKPTTjeiMi1n-IR39g";
...
pub(crate) const TELEMETRY_SERVICE_URL: &str = "https://telemetry.creditchain.io";
pub(crate) const MAINNET_TELEMETRY_SERVICE_URL: &str = "https://telemetry.mainnet.creditchain.io";

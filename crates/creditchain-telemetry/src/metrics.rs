...
pub(crate) static CREDITCHAIN_TELEMETRY_SERVICE_SUCCESS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_telemetry_service_success",
...
pub(crate) static CREDITCHAIN_TELEMETRY_SERVICE_FAILURE: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_telemetry_service_failure",
...
pub(crate) static CREDITCHAIN_TELEMETRY_SUCCESS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_telemetry_success",
...
/// TODO: Clean up when cleaning up telemetry exporter to GA
pub(crate) static CREDITCHAIN_TELEMETRY_FAILURE: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "creditchain_telemetry_failure",
...
pub(crate) static CREDITCHAIN_LOG_INGEST_SUCCESS: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "creditchain_log_ingest_success",
...
/// Counter for successful log ingest events sent to Telemetry Service
pub(crate) static CREDITCHAIN_LOG_INGEST_TOO_LARGE: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "creditchain_log_ingest_too_large",
...
pub(crate) static CREDITCHAIN_LOG_INGEST_FAILURE: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "creditchain_log_ingest_failure",

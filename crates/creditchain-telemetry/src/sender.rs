...
use creditchain_config::config::{NodeConfig, RoleType};
...
use creditchain_telemetry_service::types::{
...
mod tests {
    ...
    use super::*;
    use crate::metrics::{CREDITCHAIN_TELEMETRY_SERVICE_FAILURE, CREDITCHAIN_TELEMETRY_SERVICE_SUCCESS};

...
macro_rules! build_information {
    () => {{
        let mut build_information = creditchain_build_info::get_build_information();

        build_information.insert(
            creditchain_build_info::BUILD_PKG_VERSION.into(),
...
fn get_build_profile_name() -> String {
    ...
    // e.g. /code/core/target/debug/build/creditchain-build-info-9f91ba6f99d7a061/out
    std::env!("OUT_DIR")

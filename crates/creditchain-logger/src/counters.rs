...
pub static STRUCT_LOG_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!("creditchain_struct_log_count", "Count of the struct logs.").unwrap()
});
...
pub static PROCESSED_STRUCT_LOG_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "creditchain_struct_log_processed_count",
...
pub static ERROR_LOG_COUNT: Lazy<IntCounter> =
    Lazy::new(|| register_int_counter!("creditchain_error_log_count", "Count of error!() logs").unwrap());
pub static WARN_LOG_COUNT: Lazy<IntCounter> =
    Lazy::new(|| register_int_counter!("creditchain_warn_log_count", "Count of warn!() logs").unwrap());
pub static INFO_LOG_COUNT: Lazy<IntCounter> =
    Lazy::new(|| register_int_counter!("creditchain_info_log_count", "Count of info!() logs").unwrap());
...
pub static STRUCT_LOG_QUEUE_ERROR_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "creditchain_struct_log_queue_error_count",
...
pub static STRUCT_LOG_PARSE_ERROR_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "creditchain_struct_log_parse_error_count",
        "Count of all parse errors during struct logs."
    )
    .unwrap()
});

/// Counter for failed log ingest writes (see also: creditchain-telemetry for sender metrics)
pub static CREDITCHAIN_LOG_INGEST_WRITER_FULL: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "creditchain_log_ingest_writer_full",
...
/// Counter for failed log ingest writes (see also: creditchain-telemetry for sender metrics)
pub static CREDITCHAIN_LOG_INGEST_WRITER_DISCONNECTED: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "creditchain_log_ingest_writer_disconnected",

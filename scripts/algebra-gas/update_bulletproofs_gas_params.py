...
def main(gas_per_ns):
    path = Path('creditchain-move/aptos-gas/src/creditchain_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs module in `creditchain-move/aptos-gas/src/creditchain_framework.rs`.')

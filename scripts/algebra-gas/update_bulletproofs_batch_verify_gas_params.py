...
# so this should be larger than `LATEST_GAS_FEATURE_VERSION` in `creditchain-move/aptos-gas/src/gas_meter.rs`.
...
def main(gas_per_ns):
    path = Path('creditchain-move/creditchain-gas-schedule/src/gas_schedule/creditchain_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs batch verification in `creditchain-move/creditchain-gas-schedule/src/gas_schedule/creditchain_framework.rs`.')

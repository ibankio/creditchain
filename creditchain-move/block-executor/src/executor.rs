...
use crate::{
    ...
    code_cache_global_manager::CreditChainModuleCacheManagerGuard,
    counters::{
...
use creditchain_vm_logging::{alert, clear_speculative_txn_logs, init_speculative_logs, prelude::*};
    ...
    S: TStateView<Key = T::Key> + Sync,
{
    ...
    global_module_cache:
        &'a GlobalModuleCache<ModuleId, CompiledModule, Module, CreditChainModuleExtension>,
    ...
    TP: TxnProvider<T> + Sync,
{
    ...
    fn process_execution_result<'a>(
        ...
        read_set: &mut CapturedReads<T, ModuleId, CompiledModule, Module, CreditChainModuleExtension>,
        txn_idx: TxnIndex,
    ...
    fn finalize_parallel_execution(
        ...
        last_input_output: TxnLastInputOutput<T, E::Output, E::Error>,
        module_cache_manager_guard: &mut CreditChainModuleCacheManagerGuard,
    ...
    fn add_module_write_to_module_cache(
        ...
        per_block_module_cache: &impl ModuleCache<
            ...
            Verified = Module,
            Extension = CreditChainModuleExtension,

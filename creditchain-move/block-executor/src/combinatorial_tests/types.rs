...
use creditchain_aggregator::delta_change_set::{delta_add, delta_sub, serialize, DeltaOp};
...
use creditchain_vm_types::module_write_set::ModuleWrite;
use bytes::Bytes;
    ...
    > Transaction for MockTransaction<K, E>
{
    ...
    fn from_txn(txn: creditchain_types::transaction::Transaction) -> Self {
        match txn {

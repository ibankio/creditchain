...
use creditchain_vm_types::resolver::{
...
pub(crate) struct ParallelState<'a, T: Transaction> {
    ...
    pub(crate) captured_reads:
        RefCell<CapturedReads<T, ModuleId, CompiledModule, Module, CreditChainModuleExtension>>,
}

fn get_delayed_field_value_impl<T: Transaction>(
    captured_reads: &RefCell<
        CapturedReads<T, ModuleId, CompiledModule, Module, CreditChainModuleExtension>,
    >,
...
mod test {
    ...
    use creditchain_vm_types::resolver::TResourceView;

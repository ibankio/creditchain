...
#[cfg(test)]
use creditchain_types::on_chain_config::CurrentTimeMicroseconds;
...
use creditchain_vm_types::module_and_script_storage::module_storage::CreditChainModuleStorage;
#[cfg(test)]
use fail::fail_point;
...
impl<T: Transaction, S: TStateView<Key = T::Key>> CreditChainModuleStorage for LatestView<'_, T, S> {
    fn unmetered_get_module_state_value_metadata(
        ...
        // CreditChainModuleStorage trait only).
        #[cfg(test)]

# CreditChain VM Profiling Scripts

This is a collection of scripts to profile the Move VM and the CreditChain VM using Valgrind,
...
## Running the Scripts
To run the scripts, simply invoke the main binary via `cargo run -p creditchain-vm-profiling`.

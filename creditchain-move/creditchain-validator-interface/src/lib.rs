...
pub trait CreditChainValidatorInterface: Sync {
...
async fn handler_thread(
    db: Arc<dyn CreditChainValidatorInterface + Send>,
...
impl DebuggerStateView {
    pub fn new(db: Arc<dyn CreditChainValidatorInterface + Send>, version: Version) -> Self {

...
use crate::traits::{CreditChainGasMeter, GasAlgebra};
use creditchain_gas_algebra::{Fee, FeePerGasUnit, NumTypeNodes};
...
/// The official gas meter used inside the CreditChain VM.
...
impl<A> CreditChainGasMeter for StandardGasMeter<A>
where
    A: GasAlgebra,
{
    type Algebra = A;

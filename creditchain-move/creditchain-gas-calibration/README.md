---
id: creditchain-gas-calibration
title: CreditChain Automated Gas Calibration
---

## CreditChain Automated Gas Calibration

The CreditChain Automated Gas Calibration is a tool that lets anyone write Move Samples (or also Move IR) to calibrate the gas parameters for Native Functions (and also Move bytecode instructions). 
...
Usage: creditchain-gas-calibration [OPTIONS]
...
public fun calibrate_blake2b_256_impl(num_iterations: u64) {
    ...
    while i < num_iterations {
        ...
        creditchain_hash::blake2b_256(msg);
        creditchain_hash::blake2b_256(msg);
        creditchain_hash::blake2b_256(msg);
        creditchain_hash::blake2b_256(msg);
        creditchain_hash::blake2b_256(msg);

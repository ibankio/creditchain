module bonding_curve_launchpad::liquidity_pairs {
    ...
    use creditchain_framework::object::{Self, Object, ExtendRef};
    use creditchain_framework::event;
    use creditchain_framework::fungible_asset;
    use creditchain_framework::fungible_asset::{Metadata, TransferRef, FungibleAsset, FungibleStore};
    ...
    public(friend) fun swap_fa_to_apt(
        ...
        creditchain_account::transfer(&liquidity_pair_signer, swapper_address, apt_gained);
    ...
    public(friend) fun swap_apt_to_fa(
        ...
        creditchain_account::transfer(swapper_account, liquidity_pair_address, apt_given);
    ...
    fun graduate(
        ...
        router::create_pool_coin<CreditChainCoin>(fa_object_metadata, false);
        let liquidity_pair_signer = object::generate_signer_for_extending(&liquidity_pair.extend_ref);
        add_liquidity_coin_entry_transfer_ref<CreditChainCoin>(
            transfer_ref,
            &liquidity_pair_signer,
        ...
        let apt_coin_wrapped = coin_wrapper::get_wrapper<CreditChainCoin>();

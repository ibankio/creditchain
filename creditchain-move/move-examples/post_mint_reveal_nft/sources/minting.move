...
module post_mint_reveal_nft::minting {
    ...
    public entry fun set_treasury(admin: &signer, new_treasury_address: address) acquires NFTMintConfig {
        ...
        creditchain_account::assert_account_is_registered_for_apt(new_treasury_address);
    ...
    fun mint_source_certificate_internal(
        ...
        coin::transfer<CreditChainCoin>(nft_claimer, nft_mint_config.treasury, price * amount);
    ...
    public fun set_up_test(
        ...
        let (burn_cap, mint_cap) = creditchain_framework::creditchain_coin::initialize_for_test(creditchain_framework);
        coin::register<CreditChainCoin>(wl_nft_claimer);
        coin::register<CreditChainCoin>(public_nft_claimer);
        coin::register<CreditChainCoin>(treasury_account);
    ...
    public entry fun test_happy_path(
        ...
        set_up_test(&admin_account, &wl_nft_claimer, &public_nft_claimer, &treasury_account, &creditchain_framework, 10, 0);
        ...
        assert!(coin::balance<CreditChainCoin>(signer::address_of(&treasury_account)) == 20, 1);
        assert!(coin::balance<CreditChainCoin>(signer::address_of(&wl_nft_claimer)) == 90, 2);
        assert!(coin::balance<CreditChainCoin>(signer::address_of(&public_nft_claimer)) == 90, 3);
    ...
    public entry fun test_adding_token_uris_exceeds_collection_maximum(
        ...
        set_up_test(&admin_account, &wl_nft_claimer, &public_nft_claimer, &treasury_account, &creditchain_framework, 10, 2);
        set_public_minting_and_reveal_config(&admin_account, 201, 400, 10, 400);
        set_up_whitelist_stage(&admin_account, 50, 200, 5, 0);
        let wl_addresses = vector::empty<address>();
        vector::push_back(&mut wl_addresses, signer::address_of(&wl_nft_claimer));
    ...
    public entry fun test_minting_source_certificate_exceeds_collection_maximum(
        ...
        set_up_test(&admin_account, &wl_nft_claimer, &public_nft_claimer, &treasury_account, &creditchain_framework, 10, 3);
        set_public_minting_and_reveal_config(&admin_account, 201, 400, 10, 400);
        set_up_whitelist_stage(&admin_account, 50, 200, 5, 0);
        let wl_addresses = vector::empty<address>();
        vector::push_back(&mut wl_addresses, signer::address_of(&wl_nft_claimer));
    ...
    public entry fun set_up_multi_stage_whitelist_test(
        ...
        set_up_test(&admin_account, wl_nft_claimer, wl_nft_claimer2, &treasury_account, &creditchain_framework, 10, 0);
    ...
    public entry fun test_multi_stage_whitelist_happy_path(
        ...
        assert!(coin::balance<CreditChainCoin>(signer::address_of(&wl_nft_claimer2)) == 94, 4);
    }

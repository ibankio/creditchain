module drand::lottery_test {
    ...
    #[test(myself = @drand, fx = @creditchain_framework, u1 = @0xA001, u2 = @0xA002, u3 = @0xA003, u4 = @0xA004)]
    fun test_lottery(
        ...
        while(!vector::is_empty(&vec_signed_bytes)) {
            ...
            // Create fake coins for users participating in lottery & initialize creditchain_framework

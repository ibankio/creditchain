...
module message_board::MessageBoardTests {
    ...
    fun create_two_signers(): (signer, signer) {
        ...
        creditchain_framework::account::create_account_for_test(signer::address_of(&alice));
        creditchain_framework::account::create_account_for_test(signer::address_of(&bob));
        (alice, bob)
    }
}

script {
    ...
    fun main(
        ...
        let coin_first = coin::withdraw<creditchain_coin::CreditChainCoin>(first, amount_first);
        let coin_second = coin::withdraw<creditchain_coin::CreditChainCoin>(second, amount_second);

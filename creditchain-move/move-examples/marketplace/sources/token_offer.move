...
module token_offer {
    ...
    inline fun cleanup<CoinType>(
        ...
        creditchain_account::deposit_coins(object::owner(token_offer), coins);
...
module token_offer_tests {
    ...
    fun test_token_v2(
        ...
        let token_offer = token_offer::init_for_tokenv2<CreditChainCoin>(
            purchaser,
            token,
        ...
        assert!(coin::balance<CreditChainCoin>(purchaser_addr) == 9499, 0);
        assert!(coin::balance<CreditChainCoin>(seller_addr) == 10000, 0);

        token_offer::sell_tokenv2<CreditChainCoin>(seller, token_offer);
    ...
    fun test_token_v1_direct_deposit(
        ...
        let token_offer = token_offer::init_for_tokenv1<CreditChainCoin>(
            purchaser,
            creator_addr,
            collection_name,
            token_name,
        ...
        token_offer::sell_tokenv1<CreditChainCoin>(seller, token_offer, token_name, property_version);
        assert!(coin::balance<CreditChainCoin>(marketplace_addr) == 6, 0);
        assert!(coin::balance<CreditChainCoin>(purchaser_addr) == 9499, 0);
        assert!(coin::balance<CreditChainCoin>(seller_addr) == 10495, 0);
    ...
    fun test_token_v1_indirect(
        ...
        let token_container = token_offer::sell_tokenv1<CreditChainCoin>(
            seller,
            token_offer,
            token_name,
            property_version,
    ...
    fun test_token_v2_has_none(
        ...
        token_offer::sell_tokenv2<CreditChainCoin>(marketplace, token_offer);
    }
    ...
    fun test_token_v1_has_none(
        ...
        token_offer::sell_tokenv1<CreditChainCoin>(
            marketplace,
            token_offer,
            token_name,
            property_version,
    ...
    fun test_token_v2_exhausted(
        ...
        token_offer::sell_tokenv2<CreditChainCoin>(seller, token_offer);
        token_offer::sell_tokenv2<CreditChainCoin>(purchaser, token_offer);
    }

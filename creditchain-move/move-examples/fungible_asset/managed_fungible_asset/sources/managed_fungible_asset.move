...
module example_addr::managed_fungible_asset {
    use creditchain_framework::fungible_asset::{Self, MintRef, TransferRef, BurnRef, Metadata, FungibleStore, FungibleAsset};
    ...
    #[test_only]
    use creditchain_framework::object::object_from_constructor_ref;
    #[test_only]
    use std::string::utf8;
    use std::vector;

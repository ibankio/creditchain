...
module swap::coin_wrapper {
    ...
    use creditchain_framework::fungible_asset::{Self, BurnRef, FungibleAsset, Metadata, MintRef};
    ...
    /// CoinStore<CoinType> resource. See coin.move in the CreditChain Framework for more details.
    struct WrapperAccount has key {
        ...
        // Map from an original coin type (represented as strings such as "0x1::creditchain_coin::CreditChainCoin") to the
    ...
    /// The return value is a String such as "0x1::creditchain_coin::CreditChainCoin" for an original coin or "0x12345" for a native
    /// fungible asset.
    ...
    public(friend) fun wrap<CoinType>(coins: Coin<CoinType>): FungibleAsset acquires WrapperAccount {
        ...
        creditchain_account::deposit_coins(wrapper_address(), coins);

...
module swap::router {
    ...
    use creditchain_framework::fungible_asset::{Self, FungibleAsset, Metadata};
    ...
    public entry fun swap_asset_for_coin_entry<ToCoin>(
        ...
        creditchain_account::deposit_coins(recipient, out);
    }
    ...
    public entry fun remove_liquidity_coin_entry<CoinType>(
        ...
        creditchain_account::deposit_coins<CoinType>(recipient, amount_1);
        primary_fungible_store::deposit(recipient, amount_2);
    }
    ...
    public entry fun remove_liquidity_both_coins_entry<CoinType1, CoinType2>(
        ...
        creditchain_account::deposit_coins<CoinType1>(recipient, amount_1);
        creditchain_account::deposit_coins<CoinType2>(recipient, amount_2);
    }

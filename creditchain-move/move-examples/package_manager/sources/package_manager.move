...
/// 1. Deploy the package, including this package_manager module, using the CreditChain CLI command create-resource-and-publish-package
...
module package::package_manager {
    ...
    public fun initialize_for_test(deployer: &signer) {
        ...
        if (!exists<PermissionConfig>(deployer_addr)) {
            creditchain_framework::timestamp::set_time_has_started_for_testing(&account::create_signer_for_test(@0x1));

...
use anyhow::anyhow;
use creditchain_aggregator::types::DelayedFieldValue;
...
use creditchain_vm_types::{resolver::ResourceGroupSize, resource_group_adapter::group_size_as_sum};
...
> {
    ...
    module_cache:
        UnsyncModuleCache<ModuleId, CompiledModule, Module, CreditChainModuleExtension, Option<TxnIndex>>,
    ...
    > UnsyncMap<K, T, V, I>
{
    ...
    fn insert_group_op(
        ...
        use creditchain_types::write_set::WriteOpKind::*;

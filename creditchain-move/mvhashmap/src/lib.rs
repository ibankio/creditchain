...
use creditchain_types::{
    executable::ModulePath, vm::modules::CreditChainModuleExtension, write_set::TransactionWrite,
};
...
pub struct MVHashMap<K, T, V: TransactionWrite, I: Clone> {
    ...
    module_cache:
        SyncModuleCache<ModuleId, CompiledModule, Module, CreditChainModuleExtension, Option<TxnIndex>>,

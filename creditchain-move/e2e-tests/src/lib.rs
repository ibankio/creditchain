...
//! Test infrastructure for the CreditChain VM.
//!
//! This crate contains helpers for executing tests against the CreditChain VM.

use creditchain_types::{transaction::TransactionStatus, vm_status::KeptVMStatus};

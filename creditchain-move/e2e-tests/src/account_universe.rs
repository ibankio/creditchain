...
//! A model to test properties of common CreditChain transactions.
//!
//! The structs and functions in this module together form a simplified *model* of how common CreditChain

...
use creditchain_vm::data_cache::get_resource_group_member_from_metadata;
...
pub struct CreditChainValueAnnotator<'a, S>(MoveValueAnnotator<ModuleView<'a, S>>);

impl<'a, S: StateView> CreditChainValueAnnotator<'a, S> {

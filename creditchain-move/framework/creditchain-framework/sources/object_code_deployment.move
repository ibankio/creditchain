...
module creditchain_framework::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::features;
    use std::signer;
    ...
    use creditchain_framework::code::PackageRegistry;
    use creditchain_framework::event;
    use creditchain_framework::object;
    use creditchain_framework::object::{ExtendRef, Object};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"creditchain_framework::object_code_deployment";

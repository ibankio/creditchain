...
module creditchain_framework::multisig_account {
    use creditchain_framework::account::{Self, SignerCapability, new_event_handle, create_resource_address};
    ...
    use creditchain_framework::timestamp::now_seconds;
    ...
    /// account.
    const DOMAIN_SEPARATOR: vector<u8> = b"creditchain_framework::multisig_account";
    ...
    fun create_multisig_account(owner: &signer): (signer, SignerCapability) {
        ...
        // flow.
        if (!coin::is_account_registered<CreditChainCoin>(address_of(&multisig_signer))) {
            coin::register<CreditChainCoin>(&multisig_signer);
        };
    ...
    #[test_only]
    use creditchain_framework::coin::{destroy_mint_cap, destroy_burn_cap};
    ...
    fun setup() {
        ...
        let (burn, mint) = creditchain_coin::initialize_for_test(framework_signer);

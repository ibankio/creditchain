...
module creditchain_framework::optional_aggregator {
    use std::error;
    use std::option::{Self, Option};

    use creditchain_framework::aggregator_factory;
    use creditchain_framework::aggregator::{Self, Aggregator};
    ...
    #[test(account = @creditchain_framework)]
    #[expected_failure(abort_code = 0x020001, location = creditchain_framework::aggregator)]
    ...
    #[test(account = @creditchain_framework)]
    #[expected_failure(abort_code = 0x020002, location = creditchain_framework::aggregator)]

...
module creditchain_framework::object {
    use std::bcs;
    use std::error;
    use std::hash;
    use std::signer;
    ...
    fun test_correct_auid() {
        let auid1 = creditchain_framework::transaction_context::generate_auid_address();
        let bytes = creditchain_framework::transaction_context::get_transaction_hash();
        ...
        let auid2 = creditchain_framework::from_bcs::to_address(std::hash::sha3_256(bytes));

...
module creditchain_framework::primary_fungible_store {
    use creditchain_framework::dispatchable_fungible_asset;
    use creditchain_framework::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata, MintRef, TransferRef, BurnRef};
    use creditchain_framework::object::{Self, Object, ConstructorRef, DeriveRef};
    ...
    public fun grant_apt_permission(
        ...
        fungible_asset::grant_permission_by_address(
            master,
            permissioned,
            object::create_user_derived_object_address(signer::address_of(permissioned), @creditchain_fungible_asset),
            amount
        );
    }

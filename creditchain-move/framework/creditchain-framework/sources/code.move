...
module creditchain_framework::code {
    ...
    friend creditchain_framework::object_code_deployment;
    ...
    fun initialize(creditchain_framework: &signer, package_owner: &signer, metadata: PackageMetadata)

...
module creditchain_framework::voting {
    ...
    use creditchain_framework::transaction_context;
    ...
    public fun create_proposal_with_empty_execution_hash_should_fail_generic(
        ...
        account::create_account_for_test(@creditchain_framework);
        let governance_address = signer::address_of(governance);
    ...
    #[test(creditchain_framework = @creditchain_framework, governance = @0x123)]
    public entry fun test_voting_passed(creditchain_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_generic(creditchain_framework, governance, false, false);
    }

    #[test(creditchain_framework = @creditchain_framework, governance = @0x123)]
    public entry fun test_voting_passed_multi_step(creditchain_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_generic(creditchain_framework, governance, true, true);
    }
    ...
    public entry fun test_voting_passed_multi_step_cannot_use_single_step_resolve_function(
        ...
        test_voting_passed_generic(creditchain_framework, governance, true, false);
    }
    ...
    public entry fun test_voting_passed_single_step_can_use_generic_function(
        ...
        test_voting_passed_generic(creditchain_framework, governance, false, true);
    }
    ...
    public entry fun test_cannot_resolve_twice(creditchain_framework: &signer, governance: &signer) acquires VotingForum {
        test_cannot_resolve_twice_generic(creditchain_framework, governance, false);
    }
    ...
    public entry fun test_cannot_resolve_twice_multi_step(
        ...
        test_cannot_resolve_twice_generic(creditchain_framework, governance, true);
    }
    ...
    #[test(creditchain_framework = @creditchain_framework, governance = @0x123)]
    public entry fun test_voting_passed_early(creditchain_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_early_generic(creditchain_framework, governance, false);
    }
    ...
    public entry fun test_voting_passed_early_multi_step(
        ...
        test_voting_passed_early_generic(creditchain_framework, governance, true);
    }
    ...
    public entry fun test_voting_passed_early_in_same_tx_should_fail(
        ...
        test_voting_passed_early_in_same_tx_should_fail_generic(creditchain_framework, governance, false);
    }
    ...
    public entry fun test_voting_passed_early_in_same_tx_should_fail_multi_step(
        ...
        test_voting_passed_early_in_same_tx_should_fail_generic(creditchain_framework, governance, true);
    }
    ...
    public entry fun test_voting_failed(creditchain_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_generic(creditchain_framework, governance, false);
    }

    #[test(creditchain_framework = @creditchain_framework, governance = @0x123)]
    #[expected_failure(abort_code = 0x30002, location = Self)]
    public entry fun test_voting_failed_multi_step(creditchain_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_generic(creditchain_framework, governance, true);
    }
    ...
    #[test(creditchain_framework = @creditchain_framework, governance = @0x123)]
    #[expected_failure(abort_code = 0x30002, location = Self)]
    public entry fun test_voting_failed_early(creditchain_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_early_generic(creditchain_framework, governance, true);
    }
    ...
    public entry fun test_voting_failed_early_multi_step(
        ...
        test_voting_failed_early_generic(creditchain_framework, governance, false);
    }
    ...
    public entry fun test_cannot_set_min_threshold_higher_than_early_resolution(
        ...
        test_cannot_set_min_threshold_higher_than_early_resolution_generic(creditchain_framework, governance, false);
    }
    ...
    public entry fun test_cannot_set_min_threshold_higher_than_early_resolution_multi_step(
        ...
        test_cannot_set_min_threshold_higher_than_early_resolution_generic(creditchain_framework, governance, true);
    }

    #[test(creditchain_framework = @creditchain_framework, governance = @0x123)]
    public entry fun test_replace_execution_hash(creditchain_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@creditchain_framework);
        timestamp::set_time_has_started_for_testing(creditchain_framework);

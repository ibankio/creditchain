spec creditchain_framework::code {
    /// <high-level-req>
    /// No.: 1
    ...
    /// Enforcement: The CreditChain upgrade native functions have been manually audited.
    ///
    /// No.: 2
    ...
    spec initialize(creditchain_framework: &signer, package_owner: &signer, metadata: PackageMetadata) {

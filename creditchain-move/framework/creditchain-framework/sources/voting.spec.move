spec creditchain_framework::voting {
    /// <high-level-req>
    /// No.: 1
    ...
    // CurrentTimeMicroseconds existed under the @creditchain_framework.
    ...
    spec resolve_proposal_v2<ProposalType: store>(
        ...
        aborts_if len(next_execution_hash) == 0 && !exists<timestamp::CurrentTimeMicroseconds>(@creditchain_framework);

...
module creditchain_framework::chain_status {
    ...
    public(friend) fun set_genesis_end(creditchain_framework: &signer) {
        system_addresses::assert_creditchain_framework(creditchain_framework);
        move_to(creditchain_framework, GenesisEndMarker {});
    }

    #[view]
    /// Helper function to determine if CreditChain is in genesis state.
    public fun is_genesis(): bool {
        !exists<GenesisEndMarker>(@creditchain_framework)
    }

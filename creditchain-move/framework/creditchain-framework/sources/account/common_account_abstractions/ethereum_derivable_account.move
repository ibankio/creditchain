...
module creditchain_framework::ethereum_derivable_account {
    use creditchain_framework::auth_data::AbstractionAuthData;
    use creditchain_framework::common_account_abstractions_utils::{network_name, entry_function_name};
    use creditchain_framework::base16::base16_utf8_to_vec_u8;
    use creditchain_std::secp256k1;
    use creditchain_std::option;
    ...
    fun authenticate_auth_data(
        ...
        let hashed_message = creditchain_hash::keccak256(message);
        ...
        let kexHash = creditchain_hash::keccak256(public_key_without_prefix);
    ...
    use std::string::utf8;
    #[test_only]
    use creditchain_framework::auth_data::{create_derivable_auth_data};
    #[test_only]
    ...
    fun test_construct_message(framework: &signer) {
        ...
        let ethereum_address = b"0xC7B576Ead6aFb962E2DEcB35814FB29723AEC98a";
        let domain = b"localhost:3001";
        let entry_function_name = b"0x1::creditchain_account::transfer";

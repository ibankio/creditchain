module creditchain_framework::common_account_abstractions_utils {
    use std::chain_id;
    use std::string_utils;
    use std::transaction_context::{Self, EntryFunctionPayload};

    friend creditchain_framework::ethereum_derivable_account;
    friend creditchain_framework::solana_derivable_account;

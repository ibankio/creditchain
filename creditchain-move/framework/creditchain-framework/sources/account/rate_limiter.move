module creditchain_framework::rate_limiter {
    ...
    fun test_initialize_bucket(creditchain_framework: &signer) {
    ...
    #[test(creditchain_framework = @0x1)]
    fun test_request_success(creditchain_framework: &signer) {
        timestamp::set_time_has_started_for_testing(creditchain_framework);
    ...
    #[test(creditchain_framework = @0x1)]
    fun test_request_failure(creditchain_framework: &signer) {
        timestamp::set_time_has_started_for_testing(creditchain_framework);
        let bucket = initialize(10, 30);
    ...
    #[test(creditchain_framework = @0x1)]
    fun test_refill(creditchain_framework: &signer) {
        timestamp::set_time_has_started_for_testing(creditchain_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(creditchain_framework= @0x1)]
    fun test_fractional_accumulation(creditchain_framework: &signer) {
        timestamp::set_time_has_started_for_testing(creditchain_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(creditchain_framework= @0x1)]
    fun test_multiple_refills(creditchain_framework: &signer) {
        timestamp::set_time_has_started_for_testing(creditchain_framework);
        let bucket = initialize(10, 60);

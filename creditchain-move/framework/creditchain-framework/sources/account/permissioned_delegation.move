module creditchain_framework::permissioned_delegation {
    use std::error;
    ...
    use creditchain_framework::auth_data::{Self, AbstractionAuthData};
    use creditchain_framework::bcs_stream::{Self, deserialize_u8};
    use creditchain_framework::permissioned_signer::{Self, is_permissioned_signer, StorablePermissionedHandle};
    use creditchain_framework::rate_limiter;
    use creditchain_framework::rate_limiter::RateLimiter;
    #[test_only]
    use std::bcs;
    #[test_only]
    use std::option;
    ...
    #[test_only]
    use creditchain_std::ed25519::{sign_arbitrary_bytes, generate_keys, validated_public_key_to_bytes, Signature,
        public_key_into_unvalidated
    };
    #[test_only]
    use creditchain_framework::account::create_signer_for_test;
    #[test_only]
    ...
    fun test_basics(account: signer, account_copy: signer) acquires RegisteredDelegations {
        let creditchain_framework = create_signer_for_test(@creditchain_framework);

module creditchain_framework::account {
    use std::bcs;
    use std::error;
    use std::features;
    use std::hash;
    ...
    use creditchain_std::multi_ed25519;
    use creditchain_std::single_key;
    use creditchain_std::multi_key;
    ...
    #[test_only]
    /// Create signer for testing, independently of an CreditChain-style `Account`.
    ...
    public(friend) fun initialize(creditchain_framework: &signer) {
        ...
        move_to(creditchain_framework, OriginatingAddress {
    ...
    public fun originating_address(auth_key: address): Option<address> acquires OriginatingAddress {
        let address_map_ref = &OriginatingAddress[@creditchain_framework].address_map;
    ...
    entry fun set_originating_address(_account: &signer) acquires Account, OriginatingAddress {
        ...
        let address_map_ref_mut =
            &mut OriginatingAddress[@creditchain_framework].address_map;
    ...
    fun update_auth_key_and_originating_address_table(
        ...
        let address_map = &mut OriginatingAddress[@creditchain_framework].address_map;
    ...
    /// `create_account` to attempt to claim an account ahead of the creation of a resource account, if found CreditChain will
    ...
    fun test_create_signer_for_test() {
        assert!(signer::address_of(&create_signer_for_test(@creditchain_framework)) == @0x1, 0);
    ...
    #[test(alice = @0xa11ce)]
    #[expected_failure(abort_code = 65537, location = creditchain_framework::ed25519)]
    ...
    //
    #[test(bob = @0x345, framework = @creditchain_framework)]
    ...
    #[test(bob = @0x345, charlie = @0x567, framework = @creditchain_framework)]
    ...
    public entry fun test_valid_rotate_authentication_key_multi_ed25519_to_multi_ed25519(
        ...
        let address_map = &OriginatingAddress[@creditchain_framework].address_map;

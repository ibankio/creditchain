...
module creditchain_framework::fungible_asset {
    ...
    use creditchain_framework::object::{Self, Object, ConstructorRef, DeleteRef, ExtendRef};
    ...
    friend creditchain_framework::primary_fungible_store;
    friend creditchain_framework::creditchain_account;

    friend creditchain_framework::dispatchable_fungible_asset;
    ...
    inline fun register_dispatch_function_sanity_check(
        ...
        assert!(
            object::address_from_constructor_ref(constructor_ref) != @creditchain_fungible_asset,
    ...
    fun has_deposit_dispatch_function(metadata: Object<Metadata>): bool acquires DispatchFunctionStore {
        ...
        if(metadata_addr != @creditchain_fungible_asset && exists<DispatchFunctionStore>(metadata_addr)) {
    ...
    fun has_supply_dispatch_function(metadata_addr: address): bool {
        // Short circuit on LBT for better perf
        if (metadata_addr != @creditchain_fungible_asset) {
    ...
    #[test(fx = @creditchain_framework, creator = @0xcafe)]
    ...
    fun test_e2e_withdraw_limit(
        ...
        let creditchain_framework = account::create_signer_for_test(@0x1);

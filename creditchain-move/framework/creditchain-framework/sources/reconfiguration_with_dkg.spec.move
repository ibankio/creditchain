spec creditchain_framework::reconfiguration_with_dkg {
    spec module {
        pragma verify = true;
    }
    ...
    spec try_start() {
        ...
        requires exists<reconfiguration::Configuration>(@creditchain_framework);
    ...
    spec schema FinishRequirement {
        ...
        framework: signer;
        requires signer::address_of(framework) == @creditchain_framework;
        requires chain_status::is_operating();

...
module 0xcafe::deflation_token_tests {
    ...
    use creditchain_framework::fungible_asset::{Self, Metadata, TestToken};
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x70002, location = creditchain_framework::dispatchable_fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001C, location = creditchain_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x8001D, location = creditchain_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x10019, location = creditchain_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001A, location = creditchain_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001B, location = creditchain_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(major_status=1081, location = creditchain_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=2, location = creditchain_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=0x6001E, location = creditchain_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x50008, location = creditchain_framework::fungible_asset)]

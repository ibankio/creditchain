#[test_only]
module creditchain_framework::delegation_pool_integration_tests {
    use std::features;
    use std::signer;

    use creditchain_std::bls12381;
    use creditchain_std::stake;
    use creditchain_std::vector;
    ...
    use creditchain_framework::delegation_pool as dp;
    ...
    public fun initialize_for_test_custom(
        ...
        features::change_feature_flags_for_testing(creditchain_framework, vector[DELEGATION_POOLS, MODULE_EVENT], vector[]);
    }
    ...
    #[expected_failure(abort_code = 0x10007, location = creditchain_framework::stake)]
    ...
    public entry fun test_end_to_end(
        ...
        assert!(coin::balance<CreditChainCoin>(validator_address) == 800 * ONE_LBT, 2);
        ...
        assert!(coin::balance<CreditChainCoin>(validator_address) == 84999999999, 6);
        stake::assert_validator_state(pool_address, 10201000001, 5099999999, 0, 0, 0);
        dp::withdraw(validator, pool_address, 51 * ONE_LBT);
        assert!(coin::balance<CreditChainCoin>(validator_address) == 90099999998, 7);
    ...
    #[test(creditchain_framework = @creditchain_framework, validator_1 = @0x123, validator_2 = @0x234)]
    #[expected_failure(abort_code = 0x1000D, location = creditchain_framework::stake)]
    ...
    #[test(creditchain_framework = @creditchain_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x10006, location = creditchain_framework::delegation_pool)]
    ...
    public entry fun test_active_validator_withdraw_should_cap_by_inactive_stake(
        ...
        assert!(coin::balance<CreditChainCoin>(signer::address_of(validator)) == 100100000000, 2);
    ...
    public entry fun test_delegated_staking_with_owner_cap(
        ...
        assert!(coin::balance<CreditChainCoin>(signer::address_of(validator)) == 101 * ONE_LBT, 1);
    ...
    #[test(creditchain_framework = @creditchain_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x1000A, location = creditchain_framework::stake)]
    ...
    #[test(creditchain_framework = @creditchain_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x1000E, location = creditchain_framework::stake)]
    ...
    #[test(creditchain_framework = @creditchain_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x1000B, location = creditchain_framework::stake)]
    ...
    public entry fun test_removing_validator_from_active_set(
        ...
        stake::remove_validators(creditchain_framework, &vector[validator_to_remove]);

...
module 0xcafe::deflation_token {
    use creditchain_framework::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    use creditchain_framework::dispatchable_fungible_asset;
    use creditchain_framework::object::{ConstructorRef, Object};
    ...
    #[test_only]
    use creditchain_framework::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status=4037, location=creditchain_framework::dispatchable_fungible_asset)]

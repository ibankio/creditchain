spec creditchain_token::property_map {
    spec module {
        pragma verify = true;
    ...
    spec add(self: &mut PropertyMap, key: String, value: PropertyValue) {
        use creditchain_framework::simple_map;
    ...
    spec read_string(self: &PropertyMap, key: &String): String {
        ...
        aborts_if !creditchain_std::from_bcs::deserializable<String>(prop.value);
    }
    ...
    spec read_u8(self: &PropertyMap, key: &String): u8 {
        ...
        aborts_if !creditchain_std::from_bcs::deserializable<u8>(prop.value);
    }
    ...
    spec read_u64(self: &PropertyMap, key: &String): u64 {
        ...
        let prop = simple_map::spec_get(self.map, key);
        aborts_if prop.type != spec_utf8(str);
        aborts_if !creditchain_std::from_bcs::deserializable<u64>(prop.value);
    }
    ...
    spec read_address(self: &PropertyMap, key: &String): address {
        ...
        let prop = simple_map::spec_get(self.map, key);
        aborts_if prop.type != spec_utf8(str);
        aborts_if !creditchain_std::from_bcs::deserializable<address>(prop.value);
    }
    ...
    spec read_u128(self: &PropertyMap, key: &String): u128 {
        ...
        let prop = simple_map::spec_get(self.map, key);
        aborts_if prop.type != spec_utf8(str);
        aborts_if !creditchain_std::from_bcs::deserializable<u128>(prop.value);
    }
    ...
    spec read_bool(self: &PropertyMap, key: &String): bool {
        ...
        let prop = simple_map::spec_get(self.map, key);
        aborts_if prop.type != spec_utf8(str);
        aborts_if !creditchain_std::from_bcs::deserializable<bool>(prop.value);
    }
    ...
    spec create_property_value<T: copy>(data: &T): PropertyValue {
        use creditchain_std::type_info::{type_name};

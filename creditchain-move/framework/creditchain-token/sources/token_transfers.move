...
module creditchain_token::token_transfers {
    use std::signer;
    use std::string::String;
    use std::error;
    use creditchain_std::table::{Self, Table};
    use creditchain_token::token::{Self, Token, TokenId};
    ...
    public fun test_nft(creator: signer, owner: signer) acquires PendingClaims {
        ...
        creditchain_framework::account::create_account_for_test(owner_addr);
    ...
    public fun test_editions(
        ...
        creditchain_framework::account::create_account_for_test(owner0_addr);
        let owner1_addr = signer::address_of(&owner1);
        creditchain_framework::account::create_account_for_test(owner1_addr);
    ...
    public fun create_token(creator: &signer, amount: u64): TokenId {
        ...
        creditchain_framework::account::create_account_for_test(signer::address_of(creator));

/// Deprecated module
module creditchain_token::token_coin_swap {
    use std::string::String;
    use std::error;
    use creditchain_std::table::Table;
    use creditchain_std::type_info::TypeInfo;
    use creditchain_framework::event::EventHandle;
    use creditchain_token::token::{Token, TokenId};

...
/// - Exception: For the `deserialize_address` function, the function-based approach from `creditchain_std::from_bcs` is used
...
module creditchain_std::bcs_stream {
    use std::error;
    use std::vector;
    ...
    /// This function utilizes the `to_address` function from the `creditchain_std::from_bcs` module,

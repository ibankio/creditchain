...
/// a general conversion back-and-force is needed, consider the `creditchain_std::Any` type which preserves invariants.
///
/// Example:
/// ```
/// use std::bcs;
...
/// ```
module creditchain_std::from_bcs {
    ...
    friend creditchain_std::any;
    friend creditchain_std::copyable_any;

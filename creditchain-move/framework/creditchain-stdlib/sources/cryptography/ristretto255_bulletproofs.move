...
module creditchain_std::ristretto255_bulletproofs {
    use std::error;
    use std::features;
    use creditchain_std::ristretto255_pedersen as pedersen;
    use creditchain_std::ristretto255::{Self, RistrettoPoint};
    ...
    #[test_only]
    use creditchain_std::ristretto255::{Scalar, scalar_to_bytes};
    #[test_only]
    use creditchain_std::ristretto255_pedersen::commitment_equals;

    #[test_only]
    const A_DST: vector<u8> = b"CreditChainBulletproofs";
    #[test_only]

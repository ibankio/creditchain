...
module creditchain_std::keyless {
    use creditchain_std::bcs_stream::{Self, deserialize_u8};
    use std::error;
    use std::string::{Self, String};
    friend creditchain_std::federated_keyless;

    #[test_only]
    friend creditchain_std::keyless_tests;
    #[test_only]
    friend creditchain_std::federated_keyless_tests;

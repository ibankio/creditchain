module creditchain_std::smart_vector {
    use std::error;
    use creditchain_std::big_vector::{Self, BigVector};
    use creditchain_std::math64::max;
    use creditchain_std::type_info::size_of_val;
    ...
    public inline fun map_ref<T1, T2: store>(
        ...
        let result = creditchain_std::smart_vector::new<T2>();
    ...
    public inline fun filter<T: store + drop>(
        ...
        let result = creditchain_std::smart_vector::new<T>();
        self.for_each(|elem| {
    ...
    public inline fun zip_map<T1: store, T2: store, NewT: store>(
        ...
        let result = creditchain_std::smart_vector::new<NewT>();

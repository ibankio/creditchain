...
module creditchain_experimental::confidential_proof {
    use std::error;
    use std::option;
    use std::option::Option;
    use std::vector;
    use creditchain_std::ristretto255::{Self, CompressedRistretto, Scalar};
    use creditchain_std::ristretto255_bulletproofs::{Self as bulletproofs, RangeProof};
    ...
    friend creditchain_experimental::confidential_asset;
    ...
    const FIAT_SHAMIR_WITHDRAWAL_SIGMA_DST: vector<u8> = b"CreditChainConfidentialAsset/WithdrawalProofFiatShamir";
    const FIAT_SHAMIR_TRANSFER_SIGMA_DST: vector<u8> = b"CreditChainConfidentialAsset/TransferProofFiatShamir";
    const FIAT_SHAMIR_ROTATION_SIGMA_DST: vector<u8> = b"CreditChainConfidentialAsset/RotationProofFiatShamir";
    const FIAT_SHAMIR_NORMALIZATION_SIGMA_DST: vector<u8> = b"CreditChainConfidentialAsset/NormalizationProofFiatShamir";

    const BULLETPROOFS_DST: vector<u8> = b"CreditChainConfidentialAsset/BulletproofRangeProof";

...
module creditchain_experimental::sigma_protos {
    use std::error;
    ...
    use creditchain_std::ristretto255::{Self, RistrettoPoint, Scalar};

    use creditchain_experimental::helpers::cut_vector;
    ...
    const FIAT_SHAMIR_SIGMA_DST: vector<u8> = b"CreditChainVeiledCoin/WithdrawalSubproofFiatShamir";

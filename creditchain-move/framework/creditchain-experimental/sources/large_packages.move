...
/// SDK: [`aptos-python-sdk`](https://github.com/aptos-labs/aptos-python-sdk/blob/main/creditchain_sdk/package_publisher.py).
///
/// CreditChain CLI supports this as well with `--chunked-publish` flag:
...
module creditchain_experimental::large_packages {
    use std::error;
    use std::signer;
    use std::vector;
    use creditchain_std::smart_table::{Self, SmartTable};

    use creditchain_framework::code::{Self, PackageRegistry};
    use creditchain_framework::object::{Object};
    use creditchain_framework::object_code_deployment;

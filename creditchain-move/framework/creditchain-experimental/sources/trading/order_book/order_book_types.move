/// (work in progress)
module creditchain_experimental::order_book_types {
    use std::option;
    use std::option::Option;
    use creditchain_framework::big_ordered_map::{Self, BigOrderedMap};
    friend creditchain_experimental::active_order_book;
    friend creditchain_experimental::order_book;
    friend creditchain_experimental::pending_order_book_index;
    friend creditchain_experimental::market;

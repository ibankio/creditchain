...
module creditchain_experimental::active_order_book {
    use std::option::{Self, Option};
    use creditchain_std::math64::mul_div;
    ...
    use std::vector;
    #[test_only]
    use creditchain_experimental::order_book_types::{new_order_id_type, new_unique_idx_type};

    const EINVALID_MAKER_ORDER: u64 = 1;
    /// There is a code bug that breaks internal invariant
    const EINTERNAL_INVARIANT_BROKEN: u64 = 2;

    friend creditchain_experimental::order_book;

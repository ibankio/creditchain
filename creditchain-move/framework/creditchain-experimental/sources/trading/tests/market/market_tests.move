#[test_only]
module creditchain_experimental::market_tests {
    use std::option;
    use std::option::Option;
    use std::signer;
    use std::vector;
    use creditchain_framework::timestamp;
    use creditchain_experimental::event_utils::latest_emitted_events;
    use creditchain_experimental::clearinghouse_test;
    use creditchain_experimental::clearinghouse_test::{
    ...
    use creditchain_experimental::market_test_utils::{
    ...
    use creditchain_experimental::event_utils;
    use creditchain_experimental::market_types::{order_status_open};
    use creditchain_experimental::market::{new_market, new_market_config, OrderEvent};
    use creditchain_experimental::order_book_types::{OrderIdType, good_till_cancelled, post_only, immediate_or_cancel};
    ...
    #[test(
       creditchain_framework = @0x1, admin = @0x1, market_signer = @0x123, maker1 = @0x456, maker2 = @0x789
    )]
    ...
    #[test(creditchain_framework = @0x1, admin = @0x1, market_signer = @0x123, maker1 = @0x456)]

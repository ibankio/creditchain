#[test_only]
module creditchain_experimental::confidential_asset_tests {
    use std::features;
    use std::option;
    use std::signer;
    use std::string::utf8;
    ...
    use creditchain_experimental::confidential_asset;
    use creditchain_experimental::confidential_balance;
    use creditchain_experimental::confidential_proof;
    use creditchain_experimental::ristretto255_twisted_elgamal::{
    ...
    public fun set_up_for_confidential_asset_test(
        ...
        chain_id::initialize_for_test(creditchain_fx, 4);
    ...
    #[
        test(
            confidential_asset = @creditchain_experimental,
    ...
    fun fail_register_if_token_disallowed(
        ...
        confidential_asset::enable_allow_list(&creditchain_fx);
    ...
    fun success_register_if_token_allowed(
        ...
        confidential_asset::enable_allow_list(&creditchain_fx);
        confidential_asset::enable_token(&creditchain_fx, token);
    ...
    fun fail_deposit_with_coins_if_insufficient_amount(
        confidential_asset: signer, creditchain_fx: signer, alice: signer
    ) {
        chain_id::initialize_for_test(&creditchain_fx, 4);
        confidential_asset::init_module_for_testing(&confidential_asset);
        coin::create_coin_conversion_map(&creditchain_fx);
        ...
        coin::create_pairing<MockCoin>(&creditchain_fx);

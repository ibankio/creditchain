...
use creditchain_framework::{ReleaseOptions, ReleaseTarget};
use clap::Parser;

#[derive(Parser)]
#[clap(name = "creditchain-framework", author, version, propagate_version = true)]
enum Commands {
    /// Creates an CreditChain framework release for the specified target.

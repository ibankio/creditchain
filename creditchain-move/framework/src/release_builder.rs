...
use creditchain_sdk_builder::rust;
...
#[clap(name = "CreditChain Releasing", author, version)]
pub struct ReleaseOptions {
    ...
    /// while those that don't (like creditchain-experimental) can use latest language features.
    #[clap(long)]

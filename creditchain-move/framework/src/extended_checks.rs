...
use creditchain_types::vm::module_metadata::{
...
impl ExtendedChecker<'_> {
    ...
    /// creditchain-move/creditchain-vm/src/verifier/transaction_arg_validation.rs
    ...
    fn is_allowed_input_struct(&self, qid: QualifiedId<StructId>) -> bool {
        ...
        // TODO(gerben) find a nice way to keep this in sync with allowed_structs in creditchain-vm
        matches!(
            name.as_str(),
            "0x1::string::String"
                | "0x1::object::Object"

...
impl ReleaseTarget {
    ...
    pub fn packages(self) -> Vec<(&'static str, Option<&'static str>, bool)> {
        let result = vec![
            ...
            ("creditchain-stdlib", None, false),
            (
                "creditchain-framework",
                Some("cached-packages/src/creditchain_framework_sdk_builder.rs"),
                false,
            ),
            (
                "creditchain-token",
                Some("cached-packages/src/creditchain_token_sdk_builder.rs"),
                false,
            ),
            (
                "creditchain-token-objects",
                Some("cached-packages/src/creditchain_token_objects_sdk_builder.rs"),
                false,
            ),
            ("creditchain-experimental", None, true),
        ];
...
static NAMED_ADDRESSES: Lazy<BTreeMap<String, NumericalAddress>> = Lazy::new(|| {
    ...
    result.insert("creditchain_std".to_owned(), one);
    result.insert("creditchain_framework".to_owned(), one);
    result.insert("creditchain_token".to_owned(), three);
    result.insert("creditchain_token_objects".to_owned(), four);
    result.insert("creditchain_experimental".to_owned(), seven);
    result.insert("creditchain_fungible_asset".to_owned(), ten);

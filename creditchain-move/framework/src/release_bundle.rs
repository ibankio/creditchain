...
impl ReleasePackage {
    ...
    fn generate_script_proposal_impl(
        ...
        emitln!(writer, "use creditchain_framework::code;\n");
        ...
        if is_testnet && !is_multi_step {
            ...
            emitln!(
                writer,
                "let framework_signer = creditchain_governance::get_signer_testnet_only(core_resources, @{});",
                for_address
            );
...
pub fn generate_next_execution_hash_blob(
    ...
    match next_execution_hash {
        None => {
            emitln!(
            writer,
            "let framework_signer = creditchain_governance::resolve_multi_step_proposal(proposal_id, @{}, {});\n",
            for_address,
            "x\"\"",
        );
        },

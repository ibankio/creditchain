...
pub use crate::{
    creditchain_framework_sdk_builder::*, creditchain_token_objects_sdk_builder as creditchain_token_objects_stdlib,
    creditchain_token_sdk_builder as creditchain_token_stdlib,
};
...
pub fn creditchain_coin_transfer(to: AccountAddress, amount: u64) -> TransactionPayload {
    coin_transfer(CreditChainCoinType::type_tag(), to, amount)
}

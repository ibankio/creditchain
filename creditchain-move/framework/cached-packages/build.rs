...
use creditchain_framework::ReleaseTarget;
...
fn main() -> Result<()> {
    ...
    if std::env::var("SKIP_FRAMEWORK_BUILD").is_err() {
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir
                .join("creditchain-token-objects")
                .join("Move.toml")
                .display()
        );
        println!(
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("creditchain-token").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("creditchain-token").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("creditchain-framework").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("creditchain-framework").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("creditchain-stdlib").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("creditchain-stdlib").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",

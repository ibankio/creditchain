/// `PropertyMap` provides generic metadata support for `CreditChainToken`. It is a specialization of
...
module creditchain_token_objects::property_map {
    use std::bcs;
    use std::error;
    ...
    use creditchain_framework::object::{Self, ConstructorRef, Object, ExtendRef, ObjectCore};
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x10001, location = creditchain_std::from_bcs)]

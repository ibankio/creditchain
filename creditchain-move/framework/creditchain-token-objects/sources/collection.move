...
module creditchain_token_objects::collection {
    use std::error;
    use std::features;
    use std::option::{Self, Option};
    use std::signer;
    use std::string::{Self, String};
    use creditchain_framework::aggregator_v2::{Self, Aggregator, AggregatorSnapshot};
    use creditchain_framework::event;
    use creditchain_framework::object::{Self, ConstructorRef, ExtendRef, Object};

    use creditchain_token_objects::royalty::{Self, Royalty};

    friend creditchain_token_objects::token;
    ...
    #[expected_failure(abort_code = 0x50003, location = creditchain_framework::object)]
    ...
    entry fun test_create_and_transfer_as_owner(creator: &signer, trader: &signer, creditchain_framework: &signer) {
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x1000A, location = creditchain_token_objects::collection)]
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x20009, location = creditchain_token_objects::collection)]

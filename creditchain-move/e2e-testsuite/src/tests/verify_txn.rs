...
fn verify_signature() {
    ...
    let program = creditchain_stdlib::creditchain_coin_transfer(*sender.address(), 100);
...
fn good_module_uses_bad(
    ...
    let framework_modules = creditchain_cached_packages::head_release_bundle().compiled_modules();

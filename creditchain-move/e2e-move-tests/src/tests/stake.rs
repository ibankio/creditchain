...
use creditchain_types::account_address::{default_stake_pool_address, AccountAddress};
...
fn test_staking_contract() {
    ...
    assert_success!(harness.run_transaction_payload(
        &staker,
        creditchain_stdlib::staking_contract_add_stake(operator_1_address, amount)
    ));
    ...
    assert_success!(harness.run_transaction_payload(
        &staker,
        creditchain_stdlib::staking_contract_request_commission(staker_address, operator_1_address)
    ));
    ...
    assert_success!(harness.run_transaction_payload(
        &staker,
        creditchain_stdlib::staking_contract_distribute(staker_address, operator_1_address)
    ));
    ...
    assert_success!(harness.run_transaction_payload(
        &staker,
        creditchain_stdlib::staking_contract_unlock_stake(operator_1_address, amount)
    ));

module 0x1::chain_id_test {
    ...
    fun init_module(sender: &signer) {
        ...
        features::change_feature_flags_for_next_epoch(sender, vector[features::get_creditchain_stdlib_chain_id_feature()], vector[]);
        creditchain_governance::force_end_epoch(sender);
    }

    /// Fetches the chain ID (via creditchain_framework::chain_id::get()) and stores it in the ChainIdStore resource.
    public entry fun store_chain_id_from_creditchain_framework(_s: &signer) acquires ChainIdStore {

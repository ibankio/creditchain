...
fn exchange_e2e_test() {
    ...
    let result = h.run_transaction_payload(
        &origin_account,
        creditchain_stdlib::resource_account_create_resource_account_and_publish_package(
            vec![],
    ...
    assert_coin_balance(
        ...
        CREDITCHAIN_COIN_STRUCT_STRING,
        20,
    );
    ...
    assert_coin_balance(&mut h, &resource_address, CREDITCHAIN_COIN_STRUCT_STRING, 5);
    ...
    assert_coin_balance(&mut h, &resource_address, CREDITCHAIN_COIN_STRUCT_STRING, 2);
    assert_coin_balance(&mut h, &resource_address, CHLOE_COIN_STRUCT_STRING, 0);
}

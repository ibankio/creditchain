module 0xCAFE::test {
    ...
    use creditchain_std::smart_table;
    use creditchain_std::smart_table::SmartTable;
    use creditchain_std::table_with_length;
    use creditchain_std::table_with_length::TableWithLength;

...
use creditchain_cached_packages::{creditchain_stdlib, creditchain_token_sdk_builder};
use creditchain_crypto::{bls12381, PrivateKey, Uniform};
...
use creditchain_transaction_workloads_lib::{EntryPoints, LoopType};
...
fn test_gas() {
    ...
    runner.run(
        "Transfer",
        account_1,
        creditchain_stdlib::creditchain_coin_transfer(account_2_address, 1000),
    );
    ...
    runner.run(
        "CreateTransfer",
        account_1,
        creditchain_stdlib::creditchain_account_transfer(
    ...
    runner.run(
        "RotateConsensusKey",
        account_2,
        creditchain_stdlib::stake_rotate_consensus_key(
            pool_address,
            consensus_pubkey,
            proof_of_possession,
        ),
    ...
    runner.run(
        "JoinValidator100",
        account_2,
        creditchain_stdlib::stake_join_validator_set(pool_address),
    );
    runner.run(
        "AddStake",
        account_1,
        creditchain_stdlib::staking_contract_add_stake(account_2_address, 1000),
    );
    runner.run(
        "UnlockStake",
        account_1,
        creditchain_stdlib::staking_contract_unlock_stake(account_2_address, 1000),
    );
    ...
    runner.run(
        "WithdrawStake",
        account_1,
        creditchain_stdlib::staking_contract_distribute(account_1_address, account_2_address),
    );
    runner.run(
        "LeaveValidatorSet100",
        account_2,
        creditchain_stdlib::stake_leave_validator_set(pool_address),
    );
    ...
    runner.run(
        "CreateCollection",
        account_1,
        creditchain_token_sdk_builder::token_create_collection_script(
    ...
    runner.run(
        ...
        account_1,
        creditchain_token_sdk_builder::token_create_token_script(
            collection_name.clone(),
            token_name.clone(),
    ...
    runner.run(
        "MintTokenV1",
        account_1,
        creditchain_token_sdk_builder::token_mint_script(
            account_1_address,
            collection_name.clone(),
            token_name.clone(),
            1,
    ...
    runner.run(
        "MutateTokenV1",
        account_1,
        creditchain_token_sdk_builder::token_mutate_token_properties(
            account_1_address,
            account_1_address,
            collection_name.clone(),
            token_name.clone(),
    ...
    let publisher = &runner.harness.creditchain_framework_account();
    runner.publish(
        "PublishLarge",
        publisher,

...
fn test_metadata_tracking() {
    ...
    let coin_store = parse_struct_tag("0x1::coin::CoinStore<0x1::creditchain_coin::CreditChainCoin>").unwrap();
    ...
    harness.run_transaction_payload(
        &account1,
        creditchain_cached_packages::creditchain_stdlib::creditchain_account_transfer(address2, 100),
    );
    ...
    harness.run_transaction_payload(
        &account1,
        creditchain_cached_packages::creditchain_stdlib::creditchain_account_transfer(address3, 100),
    );

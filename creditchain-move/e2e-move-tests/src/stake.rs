...
pub fn initialize_staking(
    ...
    harness.run_transaction_payload(
        account,
        creditchain_stdlib::stake_initialize_stake_owner(
...
pub fn add_stake(harness: &mut MoveHarness, account: &Account, amount: u64) -> TransactionStatus {
    harness.run_transaction_payload(account, creditchain_stdlib::stake_add_stake(amount))
}
...
pub fn unlock_stake(
    ...
    harness.run_transaction_payload(account, creditchain_stdlib::stake_unlock(amount))
}
...
pub fn withdraw_stake(
    ...
    harness.run_transaction_payload(account, creditchain_stdlib::stake_withdraw(amount))
}
...
pub fn increase_lockup(harness: &mut MoveHarness, account: &Account) -> TransactionStatus {
    harness.run_transaction_payload(account, creditchain_stdlib::stake_increase_lockup())
}

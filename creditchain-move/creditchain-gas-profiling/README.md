...
## Overview
This crate implements a gas profiler that can be plugged into the CreditChain VM to generate comprehensive traces of gas usage, referred to as the transaction gas log.
...
>> cargo run -p libra2 -- move publish --profile-gas
    Finished dev [unoptimized + debuginfo] target(s) in 0.51s
     Running `/home/vgao/creditchain-core/target/debug/libra2 move publish --profile-gas`

...
use creditchain_types::on_chain_config::{Features, TimedFeatures};
...
impl SafeNativeBuilder {
    ...
    ///
    /// The closure will have access to the common CreditChain configurations (features, gas params etc.),

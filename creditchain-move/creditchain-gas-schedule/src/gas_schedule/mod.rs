...
pub use creditchain_framework::CreditChainFrameworkGasParameters;
...
pub mod gas_params {
    ...
    pub mod natives {
        use super::*;
        pub use creditchain_framework::gas_params as creditchain_framework;
        pub use move_stdlib::gas_params as move_stdlib;
        pub use table::gas_params as table;
    }
}

/// Gas parameters for everything that is needed to run the CreditChain blockchain, including
/// instructions, transactions and native functions from various packages.
#[derive(Debug, Clone)]
pub struct CreditChainGasParameters {
    pub vm: VMGasParameters,
    pub natives: NativeGasParameters,
}

impl FromOnChainGasSchedule for CreditChainGasParameters {
...
impl ToOnChainGasSchedule for CreditChainGasParameters {
...
impl InitialGasSchedule for CreditChainGasParameters {
    fn initial() -> Self {
        Self {
...
pub struct NativeGasParameters {
    ...
    pub creditchain_framework: CreditChainFrameworkGasParameters,
}
...
impl FromOnChainGasSchedule for NativeGasParameters {
    fn from_on_chain_gas_schedule(
        ...
        Ok(Self {
            ...
            creditchain_framework: FromOnChainGasSchedule::from_on_chain_gas_schedule(
                gas_schedule,
                feature_version,
            )?,
        })
...
impl NativeGasParameters {
    pub fn zeros() -> Self {
        Self {
            ...
            creditchain_framework: CreditChainFrameworkGasParameters::zeros(),
        }
    }
}
...
impl InitialGasSchedule for NativeGasParameters {
    fn initial() -> Self {
        Self {
            ...
            creditchain_framework: InitialGasSchedule::initial(),
        }
    }
}

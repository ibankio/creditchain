...
//! This module defines the gas parameters for CreditChain Framework & Stdlib.
...
crate::gas_schedule::macros::define_gas_parameters!(
    CreditChainFrameworkGasParameters,
    "creditchain_framework",
    NativeGasParameters => .creditchain_framework,
    [
        ...
        // These are dummy value, they copied from storage gas in creditchain-core/creditchain-vm/src/creditchain_vm_impl.rs

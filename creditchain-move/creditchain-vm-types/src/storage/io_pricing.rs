...
use creditchain_gas_algebra::GasExpression;
...
impl IoPricingV1 {
    fn new(gas_params: &CreditChainGasParameters) -> Self {
        Self {
...
impl IoPricingV1 {
    ...
    fn io_gas_per_write(&self, key: &StateKey, op_size: &WriteOpSize) -> InternalGas {
        use creditchain_types::write_set::WriteOpSize::*;
...
impl IoPricing {
    pub fn new(
        ...
        use creditchain_types::on_chain_config::OnChainConfig;
        use IoPricing::*;

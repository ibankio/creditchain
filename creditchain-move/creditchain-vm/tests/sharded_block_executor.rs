...
/// creditchain-vm and creditchain-language-e2e-tests, which causes static variables to have two instances in
...
mod test_utils {
    ...
    use creditchain_block_partitioner::BlockPartitioner;

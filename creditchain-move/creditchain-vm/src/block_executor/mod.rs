...
use creditchain_vm_logging::{flush_speculative_logs, init_speculative_logs};
...
use vm_wrapper::CreditChainExecutorTask;
...
#[derive(Debug)]
pub struct CreditChainTransactionOutput {
...
impl CreditChainTransactionOutput {
...
impl BlockExecutorTransactionOutput for CreditChainTransactionOutput {
...
pub struct CreditChainBlockExecutorWrapper<
    E: ExecutorTask<
        Txn = SignatureVerifiedTransaction,
        Error = VMStatus,
        Output = CreditChainTransactionOutput,
    >,
> {
...
impl<
        E: ExecutorTask<
            ...
            Output = CreditChainTransactionOutput,
        >,
    > CreditChainBlockExecutorWrapper<E>
{
    pub fn execute_block_on_thread_pool<
        S: StateView + Sync,
        L: TransactionCommitHook<Output = CreditChainTransactionOutput>,
...
// Same as CreditChainBlockExecutorWrapper with CreditChainExecutorTask
pub type CreditChainVMBlockExecutorWrapper = CreditChainBlockExecutorWrapper<CreditChainExecutorTask>;

...
pub use crate::creditchain_vm::{CreditChainSimulationVM, CreditChainVM};
...
pub trait VMValidator {
    /// Executes the prologue of the CreditChain Account and verifies that the transaction is valid.

...
#[cfg(feature = "testing")]
use creditchain_aggregator::resolver::TAggregatorV1View;
#[cfg(feature = "testing")]
use creditchain_aggregator::{bounded_math::SignedU128, types::DelayedFieldsSpeculativeError};
#[cfg(feature = "testing")]
use creditchain_aggregator::{resolver::TDelayedFieldView, types::DelayedFieldValue};
#[cfg(feature = "testing")]
use creditchain_framework::natives::randomness::RandomnessContext;
#[cfg(feature = "testing")]
use creditchain_framework::natives::{cryptography::algebra::AlgebraContext, event::NativeEventContext};
...
#[cfg(feature = "testing")]
use creditchain_table_natives::{TableHandle, TableResolver};
use creditchain_types::on_chain_config::{Features, TimedFeatures, TimedFeaturesBuilder};
#[cfg(feature = "testing")]
...
use creditchain_vm_environment::natives::creditchain_natives_with_builder;
#[cfg(feature = "testing")]
use bytes::Bytes;
#[cfg(feature = "testing")]
...
#[cfg(feature = "testing")]
struct CreditChainBlankStorage;

#[cfg(feature = "testing")]
impl CreditChainBlankStorage {
    pub fn new() -> Self {
        Self {}
    }
}
...
#[cfg(feature = "testing")]
impl TAggregatorV1View for CreditChainBlankStorage {
...
#[cfg(feature = "testing")]
impl TDelayedFieldView for CreditChainBlankStorage {
...
#[cfg(feature = "testing")]
impl TableResolver for CreditChainBlankStorage {
...
static DUMMY_RESOLVER: Lazy<CreditChainBlankStorage> = Lazy::new(|| CreditChainBlankStorage::new());

pub fn creditchain_natives(
    ...
    creditchain_natives_with_builder(&mut builder, false)
}
...
fn unit_test_extensions_hook(exts: &mut NativeContextExtensions) {
    use creditchain_framework::natives::object::NativeObjectContext;
    use creditchain_table_natives::NativeTableContext;

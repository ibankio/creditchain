...
use crate::{
    ...
    move_vm_ext::{
        session::view_with_change_set::ExecutorViewWithChangeSet, CreditChainMoveResolver, SessionExt,
        SessionId,
    },
    CreditChainVM,
};
use creditchain_types::transaction::user_transaction_context::UserTransactionContext;
use creditchain_vm_types::{change_set::VMChangeSet, storage::change_set_configs::ChangeSetConfigs};
...
impl<'r> RespawnedSession<'r> {
    pub fn spawn(
        ...
        base: &'r impl CreditChainMoveResolver,

...
use crate::{
    move_vm_ext::{
        ...
        CreditChainMoveResolver, SessionId,
    },
    transaction_metadata::TransactionMetadata,
    verifier, CreditChainVM,
};
use creditchain_gas_meter::CreditChainGasMeter;
use creditchain_gas_schedule::gas_feature_versions::RELEASE_V1_30;
use creditchain_types::{on_chain_config::Features, transaction::ModuleBundle};
use creditchain_vm_types::{
    change_set::VMChangeSet, module_and_script_storage::module_storage::CreditChainModuleStorage,

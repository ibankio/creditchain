...
use crate::{
    ...
    move_vm_ext::{
        resource_state_key, write_op_converter::WriteOpConverter, CreditChainMoveResolver, SessionId,
    },
};
use creditchain_framework::natives::{
...
use creditchain_table_natives::{NativeTableContext, TableChangeSet};

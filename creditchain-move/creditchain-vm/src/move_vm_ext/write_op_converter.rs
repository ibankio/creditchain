...
use crate::move_vm_ext::{session::BytesWithResourceLayout, CreditChainMoveResolver};
use creditchain_aggregator::delta_change_set::serialize;
...
pub(crate) struct WriteOpConverter<'r> {
    remote: &'r dyn CreditChainMoveResolver,
...
mod tests {
    ...
    use creditchain_vm_types::{
        module_and_script_storage::AsCreditChainCodeStorage,
    ...
    // TODO: Can re-use some of these testing definitions with creditchain-vm-types.

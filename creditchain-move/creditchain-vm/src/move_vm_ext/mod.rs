...
//! MoveVM and Session wrapped, to make sure CreditChain natives and extensions are always installed and
...
pub use crate::move_vm_ext::{
    resolver::{CreditChainMoveResolver, AsExecutorView, AsResourceGroupView, ResourceGroupResolver},
...
pub use creditchain_types::transaction::user_transaction_context::UserTransactionContext;

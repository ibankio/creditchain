...
use crate::move_vm_ext::{CreditChainMoveResolver, SessionExt, SessionId};
...
use creditchain_vm_environment::{
    environment::CreditChainEnvironment,
    natives::creditchain_natives_with_builder,
    prod_configs::{creditchain_default_ty_builder, creditchain_prod_vm_config},
};
use creditchain_vm_types::storage::change_set_configs::ChangeSetConfigs;
...
impl GenesisRuntimeBuilder {
    ...
    pub fn new(chain_id: ChainId) -> Self {
        ...
        let vm_config = creditchain_prod_vm_config(
        ...
        let natives = creditchain_natives_with_builder(&mut native_builder, false);
...
impl GenesisMoveVm {
    ...
    pub fn new_genesis_session<'r, R: CreditChainMoveResolver>(
        &self,
        resolver: &'r R,
...
pub struct MoveVmExt {
    pub(crate) env: CreditChainEnvironment,
}

impl MoveVmExt {
    pub fn new(env: &CreditChainEnvironment) -> Self {
        Self { env: env.clone() }
    }

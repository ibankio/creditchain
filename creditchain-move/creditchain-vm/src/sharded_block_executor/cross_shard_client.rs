...
use crate::{
    block_executor::CreditChainTransactionOutput,
    sharded_block_executor::{
        cross_shard_state_view::CrossShardStateView,
        messages::{CrossShardMsg, CrossShardMsg::RemoteTxnWriteMsg, RemoteTxnWrite},
    },
};
use creditchain_block_executor::txn_commit_hook::TransactionCommitHook;
...
impl CrossShardCommitSender {
    ...
    fn send_remote_update_for_success(
        &self,
        txn_idx: TxnIndex,
        txn_output: &CreditChainTransactionOutput,
    ) {

...
use crate::{
    block_executor::CreditChainVMBlockExecutorWrapper,
...
use creditchain_block_executor::{
    code_cache_global_manager::CreditChainModuleCacheManager, txn_provider::default::DefaultTxnProvider,
};
...
use creditchain_vm_logging::disable_speculative_logging;
    ...
    pub fn execute_transactions_with_dependencies(
        ...
        executor_thread_pool.clone().scope(|s| {
            ...
            s.spawn(move |_| {
                ...
                let ret = CreditChainVMBlockExecutorWrapper::execute_block_on_thread_pool(
                    executor_thread_pool,
                    &txn_provider,

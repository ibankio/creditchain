---
id: CreditChain-vm-benchmarks
title: CreditChain VM Benchmarks
---

## CreditChain VM Benchmarks

The CreditChain VM Benchmark allows anyone to specify a set of Move modules and benchmark 
the running time of transactions in the CreditChainVM measured in milliseconds. The CreditChain
...
```
cd creditchain-vm-benchmarks/samples
mkdir proj-name
cd proj-name
